            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2">
                    ...
                    <div class="tf-ourstore-content">
                        ...
                        <div>
                            <a href="contact-2.html" class="tf-btn btn-outline-dark radius-3"><span>Get Directions</span><i class="icon icon-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2">
                    <div class="tf-ourstore-content pl-124">
                        ...
                        <div>
                            <a href="contact-1.html" class="tf-btn btn-outline-dark radius-3"><span>Get Directions</span><i class="icon icon-arrow-right"></i></a>
                        </div>
                    </div>
                    <div class="tf-ourstore-img">
                        <img class="lazyload" data-src="images/shop/store/ourstore4.png" src="images/shop/store/ourstore4.png" alt="our-store">
                    </div>
                </div>
            </div>
        </section>
        <section class="flat-spacing-15">
            <div class="container">
                <div class="tf-grid-layout md-col-2">
                    <div class="tf-ourstore-img">
                        <img class="lazyload" data-src="images/shop/store/ourstore3.png" src="images/shop/store/ourstore3.png" alt="our-store">
                    </div>
                    <div class="tf-ourstore-content">
