...
<!-- Mirrored from themesflat.co/html/ecomus/product-rectangle.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:57 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/white-2.jpg" src="images/products/white-2.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- pink -->
                                            <div class="swiper-slide stagger-item" data-color="pink">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/pink-1.jpg" src="images/products/pink-1.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- black -->
                                            <div class="swiper-slide stagger-item" data-color="black">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/black-2.jpg" src="images/products/black-2.jpg" alt="img-product">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper" >
                                            ...
                                            <div class="swiper-slide" data-color="white">
                                                <a href="images/products/white-2.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/white-2.jpg" data-src="images/products/white-2.jpg" src="images/products/white-2.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- pink -->
                                            <div class="swiper-slide" data-color="pink">
                                                <a href="images/products/pink-1.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/pink-1.jpg" data-src="images/products/pink-1.jpg" src="images/products/pink-1.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- black -->
                                            <div class="swiper-slide" data-color="black">
                                                <a href="images/products/black-2.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/black-2.jpg" data-src="images/products/black-2.jpg" src="images/products/black-2.jpg" alt="">
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-liveview">
                                        <div class="liveview-count">40</div>
                                        <p class="fw-6">People are viewing this right now</p>
                                    </div>
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            <div class="variant-picker-label">
                                                Color: <span class="fw-6 variant-picker-label-value value-currentColor">White</span>
                                            </div>
                                            <div class="variant-picker-values">
                                                <input type="radio" name="color1" id="values-white" checked>
                                                <label class="style-text color-btn" data-color="white" for="values-white" data-value="White">
                                                    <p>White</p>
                                                </label>
                                                <input type="radio" name="color1" id="values-pink">
                                                <label class="style-text color-btn" data-color="pink" data-price="22" for="values-pink" data-value="Pink">
                                                    <p>Pink</p>
                                                </label>
                                                <input type="radio" name="color1" id="values-black">
                                                <label class="style-text color-btn" data-color="black" data-price="24" for="values-black" data-value="Black">
                                                    <p>Black</p>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="style-text size-btn" data-price="22" for="values-m" data-value="M">
                                                    <p>M</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-l">
                                                <label class="style-text size-btn" data-price="24" for="values-l" data-value="L">
                                                    <p>L</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-xl">
                                                <label class="style-text size-btn" data-price="26" for="values-xl" data-value="XL">
                                                    <p>XL</p>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price total-price">$20.00</span></a>
