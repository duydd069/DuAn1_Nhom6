...
<!-- Mirrored from themesflat.co/html/ecomus/product-giftcard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:54 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="col-md-6">
                            <div class="tf-product-media-wrap sticky-top">
                                <div class="other-image-zoom" id="gallery-swiper-started">
                                    <a href="images/shop/products/gift-card-1.png" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                        <img class="tf-image-zoom lazyload" data-zoom="images/shop/products/gift-card-1.png" data-src="images/shop/products/gift-card-1.png" src="images/shop/products/gift-card-1.png" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="style-text size-btn" data-price="10" for="values-1" data-value="$10">
                                                    <p>$10</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-2">
                                                <label class="style-text size-btn" data-price="25" for="values-2" data-value="$25">
                                                    <p>$25</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-3">
                                                <label class="style-text size-btn" data-price="50" for="values-3" data-value="$50">
                                                    <p>$50</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-4">
                                                <label class="style-text size-btn" data-price="100" for="values-4" data-value="$100">
                                                    <p>$100</p>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            ...
                                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price total-price">$10.00</span></a>
...
<!-- Mirrored from themesflat.co/html/ecomus/product-giftcard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:56 GMT -->
</html>