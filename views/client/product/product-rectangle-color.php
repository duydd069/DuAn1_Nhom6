...
<!-- Mirrored from themesflat.co/html/ecomus/product-rectangle-color.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:57 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="beige">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/beige.jpg" src="images/products/beige.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- pink -->
                                            <div class="swiper-slide stagger-item" data-color="pink">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/pink-2.jpg" src="images/products/pink-2.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- blue -->
                                            <div class="swiper-slide stagger-item" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/blue.jpg" src="images/products/blue.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- brown -->
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper" >
                                            ...
                                            <div class="swiper-slide" data-color="beige">
                                                <a href="images/products/beige.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/beige.jpg" data-src="images/products/beige.jpg" src="images/products/beige.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- pink -->
                                            <div class="swiper-slide" data-color="pink">
                                                <a href="images/products/pink-2.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/pink-2.jpg" data-src="images/products/pink-2.jpg" src="images/products/pink-2.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- blue -->
                                            <div class="swiper-slide" data-color="blue">
                                                <a href="images/products/blue.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/blue.jpg" data-src="images/products/blue.jpg" src="images/products/blue.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- brown -->
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                <input type="radio" name="color1" id="values-beige" checked>
                                                <label class="style-text rectangle-color color-btn" data-color="beige" for="values-beige" data-value="Beige">
                                                    <span class="d-inline-block rounded-full bg_beige"></span>
                                                    <p>Beige</p>
                                                </label>
                                                <input type="radio" name="color1" id="values-pink">
                                                <label class="style-text rectangle-color color-btn" data-price="10" data-color="pink" for="values-pink" data-value="Pink">
                                                    <span class="d-inline-block rounded-full bg_pink"></span>
                                                    <p>Pink</p>
                                                </label>
                                                <input type="radio" name="color1" id="values-blue">
                                                <label class="style-text rectangle-color color-btn" data-price="12" data-color="blue" for="values-blue" data-value="Blue">
                                                    <span class="d-inline-block rounded-full bg_blue"></span>
                                                    <p>Blue</p>
                                                </label>
                                                <input type="radio" name="color1" id="values-brown">
                                                <label class="style-text rectangle-color color-btn" data-price="14" data-color="brown" for="values-brown" data-value="Brown">
                                                    <span class="d-inline-block rounded-full bg_brown"></span>
                                                    <p>Brown</p>
                                                </label>
                                            </div>
                                        </div>
