...
<!-- Mirrored from themesflat.co/html/ecomus/product-frequently-bought-together-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:14:00 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <section class="flat-spacing-4 pt_0">
            ...
            <div class="container">
                <div class="tf-product-fbt-wrap">
                    ...
                    <form class="tf-product-form-fbt">
                        <div class="overflow-x-auto">
                            <div class="overflow-x-auto">
                                <div class="tf-product-fbt-list">
                                    ...
                                    <div class="tf-product-fbt-plus">
                                        <svg class="" xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9"
                                            fill="currentColor">
                            ...
                            <div class="tf-fbt-swatches">
                                <div class="tf-product-bundle-infos">
                                    <div class="tf-bundle-check">
                                        <input type="checkbox" checked="checked" id="fbt-ck-1">
                                        <label for="fbt-ck-1" class="">
                                            <i class="icon-check"></i>
                                        </label>
                                    </div>
                                    <span class="tf-product-bundle-title"><strong>This item:</strong> Ribbed modal T-shirt</span>
                                    ...
                                    <div class="tf-product-bundle-price">
                                        <div class="compare-at-price">$30.00</div>
                                        <div class="price-on-sale">$25.00</div>
                                    </div>
                                </div>
                                <div class="tf-product-bundle-infos">
                                    <div class="tf-bundle-check">
                                        <input type="checkbox" checked="checked" id="fbt-ck-2">
                                        <label for="fbt-ck-2" class="">
                                            <i class="icon-check"></i>
                                        </label>
                                    </div>
                                    <a href="#" class="tf-product-bundle-title">Ribbed Tank Top</a>
                                    <div class="tf-product-bundle-variant position-relative">
                                        <select class="tf-select">
                                            <option selected="selected">Beige / S</option>
                                            <option>Beige / M</option>
                                ...
                                <div class="tf-product-bundle-infos">
                                    <div class="tf-bundle-check">
                                        <input type="checkbox" checked="checked" id="fbt-ck-3">
                                        <label for="fbt-ck-3" class="">
                                            <i class="icon-check"></i>
                                        </label>
                                    </div>
                                ...
                                <div class="tf-product-bundle-infos">
                                    <div class="tf-bundle-check">
                                        <input type="checkbox" checked="checked" id="fbt-ck-4">
                                        <label for="fbt-ck-4" class="">
                                            <i class="icon-check"></i>
                                        </label>
                                    </div>
                        ...
                        <div class="tf-fbt-col-total-price"> 
                            <div class="tf-product-bundle-total-submit flex-wrap justify-content-center">
                                <div class="text w-100 text-center">Total price:</div>
                                <div class="compare-at-price">$86.00</div>
                                <div class="price-on-sale">$91.00</div>  
                            </div>
