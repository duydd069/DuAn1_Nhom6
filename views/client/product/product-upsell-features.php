...
<!-- Mirrored from themesflat.co/html/ecomus/product-upsell-features.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:14:00 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="brown">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/brown.jpg" src="images/products/brown.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- purple -->
                                            <div class="swiper-slide stagger-item" data-color="purple">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/purple.jpg" src="images/products/purple.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- green -->
                                            <div class="swiper-slide stagger-item" data-color="green">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/green.jpg" src="images/products/green.jpg" alt="img-product">
                                                </div>
                                            </div>
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide" data-color="brown">
                                                <a href="images/products/brown.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/brown.jpg" data-src="images/products/brown.jpg" src="images/products/brown.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- purple -->
                                            <div class="swiper-slide" data-color="purple">
                                                <a href="images/products/purple.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/purple.jpg" data-src="images/products/purple.jpg" src="images/products/purple.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- green -->
                                            <div class="swiper-slide" data-color="green">
                                                <a href="images/products/green.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/green.jpg" data-src="images/products/green.jpg" src="images/products/green.jpg" alt="img-product">
                                                </a>
                                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-badges">
                                        <div class="product-status-content">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="" width="14" height="19" viewBox="0 0 14 19" fill="none">
                                                <path
                                            ...
                                            <p class="fw-6">10 sold in last 12 hours</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tf-product-inventory">
                                        <div class="d-flex align-items-center gap-5">
                                            ...
                                            <div class="fw-6">300 in stock</div>
                                        </div>
                                        <div class="tf-progress-bar mt_5"><span style="width: 30%;"></span></div>
                                    </div>
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <input id="values-purple" type="radio" name="color1">
                                                <label class=" hover-tooltip radius-60 color-btn" data-color="purple" data-price="10" for="values-black" data-value="Purple">
                                                    <span class="btn-checkbox bg_purple"></span>
                                                    <span class="tooltip">Purple</span>
                                                </label>
                                                <input id="values-green" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn" data-color="green" data-price="12" for="values-green" data-value="Green">
                                                    <span class="btn-checkbox bg_light-green"></span>
                                        ...
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="style-text size-btn" data-price="16" for="values-xl" data-value="XL">
                                                    <p>XL</p>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tf-product-order">
                                        <div class="icon">
                                            <i class="icon-car-order"></i>
                                        </div>
                                        <p>
                                            Order in the next <span class="tf-countdown-simple">04 Hours 16 Mins</span> to get it between <strong class="text-decoration-underline">Monday, 1st July</strong> and <strong class="text-decoration-underline">Monday, 8st July</strong>
                                        </p>
                                    </div>
