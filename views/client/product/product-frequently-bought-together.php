...
<!-- Mirrored from themesflat.co/html/ecomus/product-frequently-bought-together.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:59 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="preload-wrapper">
                                    ...
                                    <div class="tf-product-bundle-wrap">
                                        ...
                                        <form class="tf-product-form-bundle">
                                            <div class="tf-bundle-products">
                                                <div class="tf-bundle-product-item item-has-checkox check mb_15">
                                                    <div class="tf-bundle-check align-self-center">
                                                        <input type="checkbox" checked="checked" id="bundle-ck-1">
                                                        <label for="bundle-ck-1" class="">
                                                            <i class="icon-check"></i>
                                                        </label>
                                                    </div>
                                                    <div class="tf-product-bundle-image">
                                                        <a href="#">
                                                            <img src="images/shop/products/p-d1.png" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="tf-product-bundle-infos">
                                                        <span class="tf-product-bundle-title"><strong>This item:</strong> Cotton jersey top</span>
                                                ...
                                                <div class="tf-bundle-product-item item-has-checkox check mb_15">
                                                    <div class="tf-bundle-check align-self-center">
                                                        <input type="checkbox" checked="checked" id="bundle-ck-2">
                                                    ...
                                                    <div class="tf-product-bundle-infos">
                                                        <a href="#" class="tf-product-bundle-title">Oversized Motif T-shirt</a>
                                                        <div class="tf-product-bundle-price">
                                                            <div class="price">$25.00</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tf-bundle-product-item item-has-checkox check">
                                                    <div class="tf-bundle-check align-self-center">
                                                        <input type="checkbox" checked="checked" id="bundle-ck-3">
                                                        <label for="bundle-ck-3" class="">
                                                            <i class="icon-check"></i>
                                                        </label>
                                                    </div>
                                                    <div class="tf-product-bundle-image">
                                                    ...
                                                    <div class="tf-product-bundle-infos">
                                                        <a href="#" class="tf-product-bundle-title">Oversized Printed T-shirt</a>
                                                        <div class="tf-product-bundle-variant position-relative">
                                                            <select class="tf-select">
                                                                <option selected="selected">Beige / S</option>
                                                                <option>Beige / M</option>
                                            ...
                                            <div class="tf-product-bundle-total-submit">
                                                ...
                                                <div class="compare-at-price">$51.00 USD</div>
                                                <div class="price-on-sale">$53.00 USD</div>  
                                            </div>
                                            <a href="#" class="tf-btn w-100 radius-3 justify-content-center btn-primary animate-hover-btn">Add selected to cart</a>
                                        </form>
                                    </div>
    ...
    <!-- modal pickup_available -->
    <div class="modal modalCentered fade modalDemo tf-product-modal modal-part-content" id="pickup_available">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="header">
                    <div class="demo-title">Pickup available</div>
                    <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                </div>
                <div class="overflow-y-auto">
                    <ul class="tf-pickup-availability-list">
                        <li class="tf-pickup-availability-item">
                            <div class="tf-pickup-availability-location">Toronto - Spadina Avenue</div>
                            <div class="tf-pickup-availability align-items-center">
                                <div>
                                ...
                                <div>
                                    <div>Pickup available at Usually ready in 24 hours</div>
                                </div>
                            </div>
                            <div>
                                Toronto ON <br>
                                Canada <br>
                                <a href="tel:+12386705" aria-describedby="a11y-external-message">+12386705</a>
                            </div>
                            <a href="https://maps.google.com/?daddr=%20Ontario%20Canada" class="tf-btn fw-6 btn-line">Check in google map<i class="icon icon-arrow1-top-left"></i></a>
                        </li>
                        <li class="tf-pickup-availability-item">
                            <div class="tf-pickup-availability-location">Toronto - Adelaide Street</div>
                            <div class="tf-pickup-availability align-items-center">
                                <div>
                                    <svg width="18" height="18" viewBox="0 0 18 18" class="">
                                        <path d="M7.6 13.2L14.65 6.15L13.25 4.75L7.6 10.4L4.75 7.55L3.35 8.95L7.6 13.2ZM0 18V0H18V18H0ZM2 16H16V2H2V16Z" fill="#428445"></path>
                            ...
                            <div>
                                250 Adelaide Street West <br>
                                Toronto ON M5H 1X6 <br>
                                Canada <br>
                                <a href="tel:+12990235" aria-describedby="a11y-external-message">+12990235</a>
                            </div>
                            <a href="https://maps.google.com/?daddr=250%20Adelaide%20Street%20West%20Ontario%20Canada" class="tf-btn fw-6 btn-line">Check in google map<i class="icon icon-arrow1-top-left"></i></a>
                        </li>
                        <li class="tf-pickup-availability-item">
                            <div class="tf-pickup-availability-location">Toronto - King Street</div>
                            <div class="tf-pickup-availability align-items-center">
                                <div>
                                    <svg width="18" height="18" viewBox="0 0 18 18" class="">
                                        <path d="M7.6 13.2L14.65 6.15L13.25 4.75L7.6 10.4L4.75 7.55L3.35 8.95L7.6 13.2ZM0 18V0H18V18H0ZM2 16H16V2H2V16Z" fill="#428445"></path>
                            ...
                            <div>
                                620 King Street West <br>
                                Toronto ON +1 238-670-5 <br>
                                Canada <br>
                                <a href="tel:+12990235" aria-describedby="a11y-external-message">+12990235</a>
                            </div>
                            <a href="https://maps.google.com/?daddr=250%20Adelaide%20Street%20West%20Ontario%20Canada" class="tf-btn fw-6 btn-line">Check in google map<i class="icon icon-arrow1-top-left"></i></a>
