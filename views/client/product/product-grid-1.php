...
<!-- Mirrored from themesflat.co/html/ecomus/product-grid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:28 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
                    ...
                    <div class="tf-breadcrumb-prev-next">
                        <a href="#" class="tf-breadcrumb-prev center">
                            <i class="icon icon-arrow-left"></i>
                        </a>
                        <a href="#" class="tf-breadcrumb-back center">
                            <i class="icon icon-shop"></i>
                        </a>
                        <a href="#" class="tf-breadcrumb-next center">
                            <i class="icon icon-arrow-right"></i>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="tf-product-media-wrap">
                                <div class="d-flex flex-column gap-10 wrapper-gallery-scroll" id="gallery-started">
                                    <a href="images/shop/products/p-d3.png" target="_blank" data-color="brown" class="item item-img-color" data-pswp-width="770px" data-pswp-height="1075px">
                                        <img class="radius-10 tf-image-zoom lazyload"  data-zoom="images/shop/products/p-d3.png" data-src="images/shop/products/p-d3.png" src="images/shop/products/p-d3.png" alt="">
                                    </a>
                                    <a href="images/shop/products/p-d3-1.jpg" target="_blank" data-color="purple" class="item item-img-color" data-pswp-width="770px" data-pswp-height="1075px">
                                        <img class="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/p-d3-1.jpg" data-src="images/shop/products/p-d3-1.jpg" src="images/shop/products/p-d3-1.jpg" alt="">
                                    </a>
                                    <a href="images/shop/products/p-d3-2.jpg" target="_blank" data-color="light-green" class="item item-img-color" data-pswp-width="770px" data-pswp-height="1075px">
                                        <img class="radius-10 tf-image-zoom lazyload" data-zoom="images/shop/products/p-d3-2.jpg" data-src="images/shop/products/p-d3-2.jpg" src="images/shop/products/p-d3-2.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="tf-product-info-wrap sticky-top">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="hover-tooltip radius-60 color-btn btn-grid-color active" for="values-brown" data-color="brown" data-value="Brown">
                                                    <span class="btn-checkbox bg-color-brown"></span>
                                                    <span class="tooltip">Brown</span>
                                                </label>
                                                <input id="values-light-purple" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn btn-grid-color" data-price="9" for="values-light-purple" data-color="purple" data-value="Light Purple">
                                                    <span class="btn-checkbox bg_purple"></span>
                                                    <span class="tooltip">Light Purple</span>
                                                </label>
                                                <input id="values-light-green" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn btn-grid-color" data-price="10" for="values-light-green" data-color="light-green" data-value="Light Green">
                                    ...
                                    <div class="tf-product-info-extra-link">
                                        ...
                                        <a href="#share_social" class="tf-product-extra-icon">
                                            <div class="icon">
...
<!-- Mirrored from themesflat.co/html/ecomus/product-grid-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:30 GMT -->
</html>