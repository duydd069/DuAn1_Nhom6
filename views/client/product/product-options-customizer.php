...
<!-- Mirrored from themesflat.co/html/ecomus/product-options-customizer.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:53 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    <div class="tf-product-info-title">
                                        <h5>Oversized Printed T-shirt</h5>
                                    </div>
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class=" hover-tooltip radius-60 color-btn" for="values-black" data-color="black" data-value="Black">
                                                    <span class="btn-checkbox bg-color-black"></span>
                                                    <span class="tooltip">Black</span>
                                                </label>
                                                <input id="values-blue" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn" for="values-blue" data-color="blue" data-value="Blue">
                                                    <span class="btn-checkbox bg-color-blue"></span>
                                                    <span class="tooltip">Blue</span>
                                                </label>
                                                <input id="values-white" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn" for="values-white" data-color="white" data-value="White">
                                    ...
                                    <div class="tf-product-item-property">
                                        <div class="tf-field">
                                            <input class="tf-field-input tf-input" placeholder=" " type="text" id="property1" name="properties[Personalize]">
                                            <label class="tf-field-label" for="property1">Personalize</label>
                                        </div>
                                    </div>
                                    <div class="tf-product-item-property">
                                        <div class="tf-field">
                                            <input class="tf-field-input tf-input" placeholder=" " type="text" id="property2" name="properties[Write your text]">
                                            <label class="tf-field-label" for="property2">Write your text</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price total-price">$18.00</span></a>
...
<!-- Mirrored from themesflat.co/html/ecomus/product-options-customizer.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:54 GMT -->
</html>