...
<!-- Mirrored from themesflat.co/html/ecomus/product-swatch-image-rounded.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:58 GMT -->
<head>
    <meta charset="utf-8">
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-price">
                                        ...
                                        <div class="compare-at-price">$20.00</div>
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="hover-tooltip image-rounded radius-60 color-btn" data-color="beige" for="values-beige" data-value="Beige">
                                                ...
                                                <label class=" hover-tooltip image-rounded radius-60 color-btn" data-color="black" data-price="10" for="values-black" data-value="Black">
                                                    <span class="btn-checkbox">
                                                ...
                                                <label class="hover-tooltip image-rounded radius-60 color-btn" data-color="blue" data-price="12" for="values-blue" data-value="Blue">
                                                    <span class="btn-checkbox">
                                                ...
                                                <label class="hover-tooltip image-rounded radius-60 color-btn" data-color="white" data-price="16" for="values-white" data-value="White">
                                                    <span class="btn-checkbox">
                                        ...
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="style-text size-btn" data-price="10" for="values-m" data-value="M">
                                                    <p>M</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-l">
                                                <label class="style-text size-btn" data-price="12" for="values-l" data-value="L">
                                                    <p>L</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-xl">
                                                <label class="style-text size-btn" data-price="14" for="values-xl" data-value="XL">
                                                    <p>XL</p>
                                                </label>
                                            </div>
                                        </div>
