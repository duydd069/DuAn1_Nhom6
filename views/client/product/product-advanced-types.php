...
<!-- Mirrored from themesflat.co/html/ecomus/product-advanced-types.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:54 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            <div class="variant-picker-label">
                                                Choose: <span class="fw-6 variant-picker-label-value value-currentName">Cotton jersey top</span>
                                            </div>
                                            <div class="variant-picker-values">
                                                <input type="radio" name="image" id="image-1" checked>
                                                <label class="style-image hover-tooltip color-btn" data-color="beige" for="image-1" data-value="Cotton jersey top">
                                                    <a href="#">
                                                        <div class="image">
                                                            <img class=" lazyload" data-src="images/shop/products/hmgoepprod.jpg" alt="" src="images/shop/products/hmgoepprod.jpg">
                                                        </div>
                                                        <p class="value-name">Cotton jersey top</p>
                                                    </a>
                                                     <span class="tooltip">Cotton jersey top</span>
                                                </label>
                                                <input type="radio" name="image" id="image-2">
                                                <label class="style-image hover-tooltip color-btn" data-color="black" for="image-2" data-value="Slim Fit Fine-knit Turtleneck Sweater">
                                                    <a href="#">
                                                        <div class="image">
                                                            <img class=" lazyload" data-src="images/shop/products/hmgoepprod6.jpg" alt="" src="images/shop/products/hmgoepprod6.jpg">
                                                        </div>
                                                        <p class="value-name">Slim Fit Fine-knit Turtleneck Sweater</p>
                                                    </a>
                                                     <span class="tooltip">Slim Fit Fine-knit Turtleneck Sweater</span>
                                                </label>
                                                <input type="radio" name="image" id="image-3">
                                                <label class="style-image hover-tooltip color-btn" data-color="blue" for="image-3" data-value="Ribbed Tank Top">
                                                    <a href="#">
                                                        <div class="image">
                                                            <img class=" lazyload" data-src="images/shop/products/hmgoepprod10.jpg" alt="" src="images/shop/products/hmgoepprod10.jpg">
                                                        </div>
                                                        <p class="value-name">Ribbed Tank Top</p>
                                                    </a>
                                                     <span class="tooltip">Ribbed Tank Top</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="hover-tooltip radius-60 color-btn" data-color="beige" for="values-beige" data-value="Beige">
                                                    <span class="btn-checkbox bg-color-beige"></span>
                                                    <span class="tooltip">Beige</span>
                                                </label>
                                                <input id="values-black" type="radio" name="color1">
                                                <label class=" hover-tooltip radius-60 color-btn" data-color="black" for="values-black" data-value="Black">
                                                    <span class="btn-checkbox bg-color-black"></span>
                                                    <span class="tooltip">Black</span>
                                                </label>
                                                <input id="values-blue" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn" data-color="blue" for="values-blue" data-value="Blue">
