...
<!-- Mirrored from themesflat.co/html/ecomus/product-style-06.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:12:51 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="grid-layout wrapper-shop" data-grid="grid-4">
                        <!-- card product 1 -->
                        <div class="card-product style-6" data-price="16.95" data-color="orange black white">
                            <div class="card-product-wrapper">
                        ...
                        <!-- card product 2 -->
                        <div class="card-product style-6" data-price="18.95" data-size="m l xl" data-color="brown light-purple light-green">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 3 -->
                        <div class="card-product style-6" data-price="10">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="images/products/white-3.jpg" src="images/products/white-3.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="images/products/white-4.jpg" src="images/products/white-4.jpg" alt="image-product">
                        ...
                        <!-- card product 4 -->
                        <div class="card-product style-6" data-price="16.95" data-size="s m l xl" data-color="white purple black">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="images/products/white-2.jpg" src="images/products/white-2.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="images/products/pink-1.jpg" src="images/products/pink-1.jpg" alt="image-product">
                        ...
                        <!-- card product 5 -->
                        <div class="card-product style-6" data-price="114.95" data-size="s m l xl" data-color="brown white">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                                    <img class="lazyload img-product" data-src="images/products/brown-2.jpg" src="images/products/brown-2.jpg" alt="image-product">
                                    <img class="lazyload img-hover" data-src="images/products/brown-3.jpg" src="images/products/brown-3.jpg" alt="image-product">
                        ...
                        <!-- card product 6 -->
                        <div class="card-product style-6" data-price="10.00" data-color="light-green black blue dark-blue white light-grey">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 7 -->
                        <div class="card-product style-6" data-price="10.00" data-size="s m l" data-color="black dark-blue beige light-blue white">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 8 -->
                        <div class="card-product style-6" data-price="9.95" data-size="s m l xl" data-color="white black blue">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 9 -->
                        <div class="card-product style-6" data-price="14.95" data-size="m l xl" data-color="brown black">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 10 -->
                        <div class="card-product style-6" data-price="18.95" data-size="s m l" data-color="black white">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 11 -->
                        <div class="card-product style-6" data-price="18.95" data-size="s m l" data-color="grey pink light-pink">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 12 -->
                        <div class="card-product style-6" data-price="18.95" data-size="s m l">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
