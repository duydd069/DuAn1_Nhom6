...
<!-- Mirrored from themesflat.co/html/ecomus/product-pre-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:14:00 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/kid-14.jpg" src="images/products/kid-14.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/kid-11.jpg" src="images/products/kid-11.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <div class="swiper-slide stagger-item">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/kid-2.jpg" src="images/products/kid-2.jpg" alt="img-product">
                                                </div>
                                            </div>
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper" >
                                            <div class="swiper-slide">
                                                <a href="images/products/kid-14.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/kid-14.jpg" data-src="images/products/kid-14.jpg" src="images/products/kid-14.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="images/products/kid-11.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/kid-11.jpg" data-src="images/products/kid-11.jpg" src="images/products/kid-11.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="images/products/kid-2.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/kid-2.jpg" data-src="images/products/kid-2.jpg" src="images/products/kid-2.jpg" alt="">
                                                </a>
                                            </div>
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-badges">
                                        <div class="badges">Pre-Order</div>
                                    </div>
                                    <div class="tf-product-info-price">
                                        <div class="price-on-sale">$130.00</div>
                                        <div class="compare-at-price">$170.00</div>
                                        <div class="badges-on-sale"><span>24</span>% OFF</div>
                                    </div>
                                        ...
                                        <div class="variant-picker-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="variant-picker-label">
                                                    Size: <span class="fw-6 variant-picker-label-value">74 cm</span>
                                                </div>
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class="style-text" for="values-1" data-value="74 cm">
                                                    <p>74 cm</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-2">
                                                <label class="style-text" for="values-2" data-value="80 cm">
                                                    <p>80 cm</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-3">
                                                <label class="style-text" for="values-3" data-value="86 cm">
                                                    <p>86 cm</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-4">
                                                <label class="style-text" for="values-4" data-value="98 cm">
                                                    <p>98 cm</p>
                                                </label>
                                            </div>
                                        </div>
...
<!-- Mirrored from themesflat.co/html/ecomus/product-pre-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:14:11 GMT -->
</html>