...
<!-- Mirrored from themesflat.co/html/ecomus/product-notification.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:14:11 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-thumbs other-image-zoom" data-direction="vertical">
                                        <div class="swiper-wrapper stagger-wrap">
                                            ...
                                            <div class="swiper-slide stagger-item" data-color="blue">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/light-blue-2.jpg" src="images/products/light-blue-2.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- Black -->
                                            <div class="swiper-slide stagger-item" data-color="black">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/black-14.jpg" src="images/products/black-14.jpg" alt="img-product">
                                                </div>
                                            </div>
                                            <!-- White -->
                                            <div class="swiper-slide stagger-item" data-color="white">
                                                <div class="item">
                                                    <img class="lazyload" data-src="images/products/white-10.jpg" src="images/products/white-10.jpg" alt="img-product">
                                                </div>
                                            </div>
                                    ...
                                    <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                        <div class="swiper-wrapper" >
                                            ...
                                            <div class="swiper-slide" data-color="blue">
                                                <a href="images/products/light-blue-2.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/light-blue-2.jpg" data-src="images/products/light-blue-2.jpg" src="images/products/light-blue-2.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- Black -->
                                            <div class="swiper-slide" data-color="black">
                                                <a href="images/products/black-14.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/black-14.jpg" data-src="images/products/black-14.jpg" src="images/products/black-14.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- White -->
                                            <div class="swiper-slide" data-color="white">
                                                <a href="images/products/white-10.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom lazyload" data-zoom="images/products/white-10.jpg" data-src="images/products/white-10.jpg" src="images/products/white-10.jpg" alt="img-product">
                                                </a>
                                            </div>
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                <input id="values-light-blue" type="radio" name="color1" checked>
                                                <label class="hover-tooltip radius-60 sold-out-line color-btn" data-color="blue" for="values-light-blue" data-value="Blue">
                                                    <span class="btn-checkbox bg_light-blue"></span>
                                                ...
                                                <label class="hover-tooltip radius-60 color-btn" data-color="black" for="values-black" data-value="Black">
                                                    <span class="btn-checkbox bg_dark"></span>
                                                    <span class="tooltip">Black</span>
                                                </label>
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a href="javascript:void(0);" class="tf-btn btns-sold-out cursor-not-allowed btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn "><span>Sold out -&nbsp;</span><span class="tf-qty-price">$8.00</span></a>
                                            ...
                                            <div class="w-100">
                                                <a href="javascript:void(0);" class="btns-full btns-sold-out cursor-auto btns-sold-out">Buy with <img src="images/payments/paypal.png" alt=""></a>
                                                <a href="#" class="payment-more-option">More payment options</a>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="tf-product-notify-stock">
                                        <form>
                                            <div class="tf-product-notify-stock-heading">
                                            ...
                                            <input type="email" name="email-form" placeholder="Enter *">
                                            <button type="submit" class="tf-btn w-100 justify-content-center btn-fill animate-hover-btn flex-shrink-0">Notify me when available</button>
                                        </form>
                                    </div>
                        ...
                        <div class="tf-sticky-atc-infos">
                            <form class="">
                                ...
                                <div class="tf-sticky-atc-btns">
                                    ...
                                    <a href="javascript:void(0);" class="tf-btn btns-sold-out cursor-not-allowed btn-fill radius-3 justify-content-center fw-6 fs-14 flex-grow-1 animate-hover-btn "><span>Sold out</a>
                                </div>
                            </form>
                        </div>
                    </div>
