...
<!-- Mirrored from themesflat.co/html/ecomus/product-swatch-dropdown-color.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:59 GMT -->
<head>
    <meta charset="utf-8">
                                ...
                                <div class="tf-product-info-list other-image-zoom">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="tf-dropdown-sort full position-relative has-color" data-bs-toggle="dropdown">
                                                <div class="btn-select">
                                                    <span class="text-sort-value select-currentColor">Beige</span>
                                                    <span class="icon icon-arrow-down"></span>
                                                </div>
                                                <div class="dropdown-menu">
                                                    <div class="select-item active color-btn" data-color="beige">
                                                        <span class="box-color d-inline-block rounded-full bg_beige"></span>
                                                        <span class="text-value-item">Beige</span>
                                                    </div>
                                                    <div class="select-item color-btn" data-color="pink" data-price="10">
                                                        <span class="box-color d-inline-block rounded-full bg_pink"></span>
                                                        <span class="text-value-item">Pink</span>
                                                    </div>
                                                    <div class="select-item color-btn" data-color="blue" data-price="12">
                                                        <span class="box-color d-inline-block rounded-full bg_blue"></span>
                                                        <span class="text-value-item">Blue</span>
                                                    </div>
                                                    <div class="select-item color-btn"data-color="brown" data-price="14">
                                                        <span class="box-color d-inline-block rounded-full bg_brown"></span>
                                                        <span class="text-value-item">Brown</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="variant-picker-item">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="variant-picker-label">
                                                    Size: <span class="fw-6 variant-picker-label-value">M</span>
                                                </div>
                                            ...
                                            <div class="tf-dropdown-sort full position-relative" data-bs-toggle="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <div class="select-item select-size size-btn active" data-value="M">
                                                        <span class="text-value-item">M</span>
                                                    </div>
                                                    <div class="select-item select-size size-btn" data-price="14" data-value="L">
                                                        <span class="text-value-item">L</span>
                                                    </div>
                                                    <div class="select-item select-size size-btn" data-price="16" data-value="XL">
