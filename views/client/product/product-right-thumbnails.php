...
<!-- Mirrored from themesflat.co/html/ecomus/product-right-thumbnails.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:31 GMT -->
<head>
    <meta charset="utf-8">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <input id="values-pink" type="radio" name="color1">
                                                <label class=" hover-tooltip radius-60 color-btn" data-color="pink" for="values-pink" data-value="Pink">
                                                    <span class="btn-checkbox bg_pink"></span>
                                                    <span class="tooltip">Pink</span>
                                                </label>
