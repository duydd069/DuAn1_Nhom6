    ...
    <div class="container">
        <div class="tf-breadcrumb-wrap d-flex justify-content-between flex-wrap align-items-center">
            <div class="tf-breadcrumb-list">
                <a href="?ctl=home" class="text">Home</a>
                <i class="icon icon-arrow-right"></i>
                <span class="text"><?= htmlspecialchars($product['product_name']) ?></span>
            </div>
                        ...
                        <div class="tf-product-info-list other-image-zoom">
                            ...
                            <div class="tf-product-info-badges">
                                ...
                                <div class="product-status-content">
                                    ...
                                    <p class="fw-6">Selling fast! 21 people have this in their carts.</p>
                                </div>
                            </div>
                            <div class="tf-product-info-price">
                                <div class="price-on-sale">$<?= htmlspecialchars($product['product_price']) ?></div>
                                <div class="badges-on-sale"><span><?= htmlspecialchars($product['discount_price']) ?>%</span> OFF</div>
                            </div>
                            ...
                            <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price total-price">$<?= htmlspecialchars($product['product_price']) ?></span></a>
                                        ...
                                        <div class="tf-payment">
                                            <img src="public/client/assets/images/payments/visa.png" alt="">
                                            <img src="public/client/assets/images/payments/img-1.png" alt="">
                                            <img src="public/client/assets/images/payments/img-2.png" alt="">
                                            <img src="public/client/assets/images/payments/img-3.png" alt="">
                                            <img src="public/client/assets/images/payments/img-4.png" alt="">
                                        </div>
                                    </div>
                                    </div>
                        </div>
