            ...
            <div class="container">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="grid-layout wrapper-shop loadmore-item scroll-loadmore" data-grid="grid-4">
                        ...
                        <!-- card product 2 -->
                        <div class="card-product fl-item" data-price="18.95" data-size="m l xl" data-color="brown light-purple light-green">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 4 -->
                        <div class="card-product fl-item" data-price="16.95" data-size="s m l xl" data-color="white purple black">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 6 -->
                        <div class="card-product fl-item" data-price="10.00" data-color="light-green black blue dark-blue white light-grey">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 7 -->
                        <div class="card-product fl-item" data-price="10.00" data-size="s m l" data-color="black dark-blue beige light-blue white">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 8 -->
                        <div class="card-product fl-item" data-price="9.95" data-size="s m l xl" data-color="white black blue">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
                        ...
                        <!-- card product 11 -->
                        <div class="card-product fl-item" data-price="18.95" data-size="s m l" data-color="grey pink light-pink">
                            <div class="card-product-wrapper">
                                <a href="product-detail.html" class="product-img">
