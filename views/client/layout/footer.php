                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="public/client/assets/images/logo/logo.svg" alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
    ...
    <!-- Javascript -->
    <script type="text/javascript" src="public/client/assets/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/swiper-bundle.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/carousel.js"></script>
    <script type="text/javascript" src="public/client/assets/js/bootstrap-select.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/lazysize.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/bootstrap-select.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/count-down.js"></script>
    <script type="text/javascript" src="public/client/assets/js/wow.min.js"></script>
    <script type="text/javascript" src="public/client/assets/js/multiple-modal.js"></script>
    <script type="text/javascript" src="public/client/assets/js/main.js"></script>
</body>


<!-- Mirrored from themesflat.co/html/ecomus/home-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:09:53 GMT -->
</html>