...
<head>
    <meta charset="utf-8">
    <title>Quần Áo Mùa Đông</title>

    <meta name="author" content="themesflat.com">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

   <!-- font -->
   <link rel="stylesheet" href="public/client/assets/fonts/fonts.css">
   <!-- Icons -->
   <link rel="stylesheet" href="public/client/assets/fonts/font-icons.css">
   <link rel="stylesheet" href="public/client/assets/css/bootstrap.min.css">
   <link rel="stylesheet" href="public/client/assets/css/swiper-bundle.min.css">
   <link rel="stylesheet" href="public/client/assets/css/animate.css">
   <link rel="stylesheet"type="text/css" href="public/client/assets/css/styles.css"/>

    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="public/client/assets/images/logo/favicon.png">
<link rel="apple-touch-icon-precomposed" href="public/client/assets/images/logo/favicon.png">
            ...
            <div class="px_15 lg-px_40">
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="?ctl=home" class="logo-header">
                            <img src="public/client/assets/images/logo/logo.svg" alt="logo" class="logo">
                        </a>
                    </div>
                                            ...
                                            <div class="row-demo">
                                                <div class="demo-item">
                                                    <a href="index.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-01.jpg" src="public/client/assets/images/demo/home-01.jpg" alt="home-01">
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-multi-brand.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-multi-brand.jpg" src="public/client/assets/images/demo/home-multi-brand.jpg" alt="home-multi-brand">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-02.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-02.jpg" src="public/client/assets/images/demo/home-02.jpg" alt="home-02">
                                                            <div class="demo-label">
                                                                <span class="demo-hot">Hot</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-03.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-03.jpg" src="public/client/assets/images/demo/home-03.jpg" alt="home-03">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-04.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-04.jpg" src="public/client/assets/images/demo/home-04.jpg" alt="home-04">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-05.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-05.jpg" src="public/client/assets/images/demo/home-05.jpg" alt="home-05">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-06.html">
                                                        <div class="demo-image position-relative">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-06.jpg" src="public/client/assets/images/demo/home-06.jpg" alt="home-06">
                                                            <div class="demo-label">
                                                                <span class="demo-new">New</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-07.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-07.jpg" src="public/client/assets/images/demo/home-07.jpg" alt="home-07">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-08.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-08.jpg" src="public/client/assets/images/demo/home-08.jpg" alt="home-08">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-skincare.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-skincare.jpg" src="public/client/assets/images/demo/home-skincare.jpg" alt="home-skincare">
                                                        </div>
                                                ...
                                                <div class="demo-item">
                                                    <a href="home-giftcard.html">
                                                        <div class="demo-image">
                                                            <img class="lazyload" data-src="public/client/assets/images/demo/home-giftcard.jpg" src="public/client/assets/images/demo/home-giftcard.jpg" alt="home-gift-card">
                                                        </div>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-men.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="public/client/assets/images/collections/collection-1.jpg" src="public/client/assets/images/collections/collection-1.jpg" alt="collection-demo-1">
                                                            </a>
                                                    ...
                                                    <div class="collection-item hover-img">
                                                        <div class="collection-inner">
                                                            <a href="shop-women.html" class="collection-image img-style">
                                                                <img class="lazyload" data-src="public/client/assets/images/collections/collection-2.jpg" src="public/client/assets/images/collections/collection-2.jpg" alt="collection-demo-2">
                                                            </a>
                                                            <div class="collection-content">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                    ...
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="public/client/assets/images/products/white-3.jpg" src="public/client/assets/images/products/white-3.jpg" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="public/client/assets/images/products/white-4.jpg" src="public/client/assets/images/products/white-4.jpg" alt="image-product">
                                                                            </div>
                                                                            <div class="list-product-btn absolute-2">
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="public/client/assets/images/products/white-2.jpg" src="public/client/assets/images/products/white-2.jpg" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="public/client/assets/images/products/pink-1.jpg" src="public/client/assets/images/products/pink-1.jpg" alt="image-product">
                                                                            </div>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="public/client/assets/images/products/white-2.jpg" src="public/client/assets/images/products/white-2.jpg" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Pink</span>
                                                                                    <span class="swatch-value bg_purple"></span>
                                                                                    <img class="lazyload" data-src="public/client/assets/images/products/pink-1.jpg" src="public/client/assets/images/products/pink-1.jpg" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">Black</span>
                                                                                    <span class="swatch-value bg_dark"></span>
                                                                                    <img class="lazyload" data-src="public/client/assets/images/products/black-2.jpg" src="public/client/assets/images/products/black-2.jpg" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product" data-src="public/client/assets/images/products/brown-2.jpg" src="public/client/assets/images/products/brown-2.jpg" alt="image-product">
                                                                                <img class="lazyload img-hover" data-src="public/client/assets/images/products/brown-3.jpg" src="public/client/assets/images/products/brown-3.jpg" alt="image-product">
                                                                            </div>
                                                                            <div class="size-list">
                                                                                <span>S</span>
                                                                                <span>M</span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    ...
                                                                                    <img class="lazyload" data-src="public/client/assets/images/products/brown-2.jpg" src="public/client/assets/images/products/brown-2.jpg" alt="image-product">
                                                                                </li>
                                                                                <li class="list-color-item color-swatch">
                                                                                    <span class="tooltip">White</span>
                                                                                    <span class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload" data-src="public/client/assets/images/products/white-5.jpg" src="public/client/assets/images/products/white-5.jpg" alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
