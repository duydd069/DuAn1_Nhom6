                            ...
                            <div class="tf-categories-container">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src="images/collections/collection-circle-8.jpg" src="images/collections/collection-circle-8.jpg" alt="collection-img">
                                    </a>
                                ...
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src="images/collections/collection-circle-9.jpg" src="images/collections/collection-circle-9.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                ...
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src="images/collections/collection-circle-10.jpg" src="images/collections/collection-circle-10.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                ...
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src="images/collections/collection-circle-11.jpg" src="images/collections/collection-circle-11.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                ...
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src="images/collections/collection-circle-12.jpg" src="images/collections/collection-circle-12.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                ...
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src="images/collections/collection-circle-13.jpg" src="images/collections/collection-circle-13.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                ...
                                <div class="collection-item-circle hover-img">
                                    <div class="has-saleoff-wrap position-relative">
                                        <a href="shop-collection-sub.html" class="collection-image img-style">
                                            <img class="lazyload" data-src="images/collections/sale.jpg" src="images/collections/sale.jpg" alt="collection-img">
                                        </a>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="images/slider/women-slideshow-1.jpg" src="images/slider/women-slideshow-1.jpg" alt="women-slideshow-01" >
                            <div class="box-content">
                                <div class="container">
                                    ...
                                    <a href="shop-default.html" class="fade-item fade-item-3 tf-btn btn-fill animate-hover-btn btn-xl radius-60"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                </div>                              
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="images/slider/women-slideshow-2.jpg" src="images/slider/women-slideshow-2.jpg" alt="women-slideshow-02">
                            <div class="box-content">
                                <div class="container">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="images/slider/women-slideshow-3.jpg" src="images/slider/women-slideshow-3.jpg" alt="women-slideshow-03">
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1">Luxury</h1>
                                    <p class="fade-item fade-item-2">From casual to formal, we've got you covered</p>
                                    <a href="shop-default.html" class="fade-item fade-item-3 tf-btn btn-fill animate-hover-btn btn-xl radius-60"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="collection-item-v4 hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-sub.html" class="collection-image img-style radius-10">
                                        <img class="lazyload" data-src="images/collections/collection-47.jpg" src="images/collections/collection-47.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                                        <h5 class="heading text_white">The January Collection</h5>
                                        <a href="shop-collection-sub.html" class="tf-btn style-3 fw-6 btn-light-icon rounded-full animate-hover-btn"><span>Shop now</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item-v4 hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-sub.html" class="collection-image img-style radius-10">
                                        <img class="lazyload" data-src="images/collections/collection-48.jpg" src="images/collections/collection-48.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                        ...
                        <div dir="ltr" class="swiper tf-sw-tes-2" data-preview="1" data-space-lg="40" data-space-md="30">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item lg lg-2">
                                        <div class="icon">
                                            <img class="lazyloaded" data-src="images/item/quote.svg" src="images/item/quote.svg" alt="" src="images/item/quote.svg">
                                        </div>
                                        <div class="heading fs-12 mb_18">PEOPLE ARE TALKING</div>
                                        <div class="rating">
                                            <i class="icon-star"></i>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="grid-img-group style-ter-1">
                                        <div class="box-img item-1 hover-img">
                                            <div class="img-style">
                                                <img class="lazyload" data-src="images/slider/te6.jpg" src="images/slider/te6.jpg" alt="img-slider">
                                            </div>
                                        </div>
                                        <div class="box-img item-2 hover-img">
                                            <div class="img-style">
                                                <img class="lazyload" data-src="images/slider/te5.jpg" src="images/slider/te5.jpg" alt="img-slider">
                                            </div>
                                        </div>
                                    </div>
                                </div>
