                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="images/slider/sneaker-1.jpg" alt="fashion-slideshow">
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="images/slider/sneaker-2.jpg" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="images/slider/sneaker-3.jpg" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
            ...
            <div class="container">
                <div class="masonry-layout-v4 wow fadeInUp" data-wow-delay="0s">
                    <div class="item-1 collection-item-v2 hover-img">
                        <a href="shop-collection-sub.html" class="collection-inner">
                            <div class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/sneaker-5.jpg" src="images/collections/sneaker-5.jpg" alt="collection-img">
                            </div>
                    ...
                    <div class="item-2 collection-item-v2 hover-img">
                        <a href="shop-collection-sub.html" class="collection-inner">
                            <div class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/sneaker-6.jpg" src="images/collections/sneaker-6.jpg" alt="collection-img">
                            </div>
                    ...
                    <div class="item-3 collection-item-v2 hover-img">
                        <a href="shop-collection-sub.html" class="collection-inner">
                            <div class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/sneaker-7.jpg" src="images/collections/sneaker-7.jpg" alt="collection-img">
                            </div>
                            <div class="collection-content justify-content-end">
                                <div class="bottom wow fadeInUp" data-wow-delay="0s">
                ...
                <div class="row align-items-center flex-md-row-reverse">
                    <div class="col-md-6">
                        <div class="collection-item-v2 hover-img">
                            <a href="shop-collection-sub.html" class="collection-inner">
                                <div class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/sneaker-8.jpg" src="images/collections/sneaker-8.jpg" alt="collection-img">
                                </div>
                                <div class="collection-content justify-content-end">
                                    <div class="bottom wow fadeInUp" data-wow-delay="0s">
                    ...
                    <div class="col-md-6">
                        <div class="tf-grid-layout tf-col-2 gap30 row-gap-10">
                            <div class="card-product">
                                <div class="card-product-wrapper rounded-0">
                                    <a href="product-detail.html" class="product-img ">
                                        <img class="lazyload img-product" data-src="images/products/sneaker-3.png" src="images/products/sneaker-3.png" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/sneaker-4.png" src="images/products/sneaker-4.png" alt="image-product">
                                    </a>
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link fw-8">POLAR NIGHT PACK PACK 2 FUSION 2.0</a>
                                    <span class="price fw-6">$144.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-3.png" src="images/products/sneaker-3.png" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-4.png" src="images/products/sneaker-4.png" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-product">
                                <div class="card-product-wrapper rounded-0">
                                    <a href="product-detail.html" class="product-img ">
                                        <img class="lazyload img-product" data-src="images/products/sneaker-5.png" src="images/products/sneaker-5.png" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/sneaker-6.png" src="images/products/sneaker-6.png" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#shoppingCart" data-bs-toggle="modal" class="box-icon quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link fw-8">SHADOW 6000 BEIGE</a>
                                    <span class="price fw-6">$144.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-5.png" src="images/products/sneaker-5.png" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-6.png" src="images/products/sneaker-6.png" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-product">
                                <div class="card-product-wrapper rounded-0">
                                    <a href="product-detail.html" class="product-img ">
                                        <img class="lazyload img-product" data-src="images/products/sneaker-7.jpg" src="images/products/sneaker-7.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/sneaker-8.jpg" src="images/products/sneaker-8.jpg" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#shoppingCart" data-bs-toggle="modal" class="box-icon quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link fw-8">RIVALRY 86 LOW WONDER</a>
                                    <span class="price fw-6">$144.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-7.jpg" src="images/products/sneaker-7.jpg" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-8.jpg" src="images/products/sneaker-8.jpg" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-product">
                                <div class="card-product-wrapper rounded-0">
                                    <a href="product-detail.html" class="product-img ">
                                        <img class="lazyload img-product" data-src="images/products/sneaker-9.png" src="images/products/sneaker-9.png" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/sneaker-10.png" src="images/products/sneaker-10.png" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#shoppingCart" data-bs-toggle="modal" class="box-icon quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link fw-8">SAMBA OG SHOES</a>
                                    <span class="price fw-6">$144.95</span>
                                    <ul class="list-color-product">
                                        <li class="list-color-item color-swatch active">
                                            <span class="tooltip">Black</span>
                                            <span class="swatch-value bg_dark"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-9.png" src="images/products/sneaker-9.png" alt="image-product">
                                        </li>
                                        <li class="list-color-item color-swatch">
                                            <span class="tooltip">White</span>
                                            <span class="swatch-value bg_white"></span>
                                            <img class="lazyload" data-src="images/products/sneaker-10.png" src="images/products/sneaker-10.png" alt="image-product">
                                        </li>
                                    </ul>
                                </div>
                            </div>
