<?php include_once "views/client/layout/header.php" ?>
                ...
                <div class="row wrapper-header align-items-center">
                    ...
                    <div class="col-xl-3 col-md-4 col-6">
                        <a href="index.html" class="logo-header">
                            <img src="images/logo/logo-white%402x.png" alt="logo" class="logo">
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="masonry-layout-v2">
                    <div class="item-1 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-59.jpg" src="images/collections/collection-59.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html" class="collection-title"><span>Clothing</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-2 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-60.jpg" src="images/collections/collection-60.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html" class="collection-title"><span>Shoes</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-3 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-61.jpg" src="images/collections/collection-61.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html" class="collection-title"><span>Slippers</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-4 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-62.jpg" src="images/collections/collection-62.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html" class="collection-title"><span>Perfume</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-5 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-63.jpg" src="images/collections/collection-63.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html" class="collection-title"><span>Bags</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-6 collection-item-v5 hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/collection-64.jpg" src="images/collections/collection-64.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-default.html" class="collection-title"><span>Hats</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-2">
                    <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                        <img class="lazyload" data-src="images/collections/collection-65.jpg" src="images/collections/collection-65.jpg" alt="collection-img">
                    </div>
        ...
        <section class="flat-spacing-13">
            <div class="container">
                <div class="flat-lookbook-v3 d-flex wrap-lookbook-hover">
                    <div class="col-left w-50">
                        <div class="slider-wrap-lookbook">
                            <div class="inner-sw-lookbook">
                                ...
                                <form class="">
                                    <div dir="ltr" class="swiper tf-lookbook bundle-hover-wrap" data-preview="3" data-tablet="1" data-mobile="1" data-space-lg="0" data-space-md="0">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide" lazy="true">
                                                <div class="tf-bundle-product-item bundle-hover-item type-lg pin1">
                                                    ...
                                                    <div class="tf-product-bundle-infos">
                                                        <a href="product-detail.html" class="tf-product-bundle-title">Patterned scarf</a>
                                            ...
                                            <div class="swiper-slide" lazy="true">
                                                <div class="tf-bundle-product-item bundle-hover-item type-lg pin2">
                                                    <div class="tf-product-bundle-image">
                                                        <a href="product-detail.html">
                                                            <img src="images/shop/products/p-d3.png" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="tf-product-bundle-infos">
                                                        <span class="tf-product-bundle-title">Ribbed modal T-shirt</span>
                                                        <div class="tf-product-bundle-price">
                                            ...
                                            <div class="swiper-slide" lazy="true">
                                                <div class="tf-bundle-product-item bundle-hover-item type-lg pin3">
                                                    <div class="tf-product-bundle-image">
                                                        <a href="product-detail.html">
                                    ...
                                    <button type="submit" class="tf-btn w-100 justify-content-center style-2 btn-fill radius-3 animate-hover-btn">Add selected to cart - $48.00 USD</button>
                                </form>
                            </div>
                        </div>  
                    </div>
                    <div class="col-right w-50">
                        <div class="wrap-lookbook lookbook-sw lookbook-3">
                            <div class="image">
                                <img class="lazyload" data-src="images/shop/file/lookbook-6.jpg" src="images/shop/file/lookbook-6.jpg" alt="collection-img">
                            </div>
                            <div class="navigation-sw-dot type-black position-absolute item-1 bundle-pin-item swiper-button" data-slide="0" id="pin1"><span></span></div>
                            <div class="navigation-sw-dot type-black position-absolute item-2 bundle-pin-item swiper-button" data-slide="1" id="pin2"><span></span></div>
                            <div class="navigation-sw-dot type-black position-absolute item-3 bundle-pin-item swiper-button" data-slide="2" id="pin3"><span></span></div>
                        </div>
                    </div>
                </div>
            </div>
