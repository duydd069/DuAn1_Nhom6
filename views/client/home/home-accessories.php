<?php include_once "views/client/layout/header.php" ?>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img src="images/slider/accessories2_slideshow1.jpg" alt="fashion-slideshow">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img src="images/slider/accessories2_slideshow2.jpg" alt="fashion-slideshow">
                            <div class="box-content text-center">
                                <div class="container">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img src="images/slider/accessories2_slideshow3.jpg" alt="fashion-slideshow">
                            <div class="box-content text-center">
                                <div class="container">
        ...
        <!-- /Slider -->
        <!-- Icon box -->
        <section class="flat-spacing-1 has-line-bottom flat-iconbox wow fadeInUp" data-wow-delay="0s">
            <div class="container">
                    ...
                    <div dir="ltr" class="swiper tf-sw-recent wow fadeInUp" data-preview="6" data-tablet="3" data-mobile="2" data-space-lg="70" data-space-md="30" data-space="15" data-pagination="2" data-pagination-md="3" data-pagination-lg="3">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class=" lazyloaded" data-src="images/collections/audio.svg" alt="collection-img" src="images/collections/audio.svg">
                                    </a>
                                    <div class="collection-content text-center">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class=" lazyloaded" data-src="images/collections/wireless-chargers.svg" alt="collection-img" src="images/collections/wireless-chargers.svg">
                                    </a>
                                    <div class="collection-content text-center">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class=" lazyloaded" data-src="images/collections/magSafe.svg" alt="collection-img" src="images/collections/magSafe.svg">
                                    </a>
                                    <div class="collection-content text-center">
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class=" lazyloaded" data-src="images/collections/gaming.svg" alt="collection-img" src="images/collections/gaming.svg">
                                    </a>
                                    <div class="collection-content text-center">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="collection-item-v4 st-lg hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-sub.html" class="collection-image img-style radius-10 o-hidden">
                                        <img class="lazyload" data-src="images/collections/accessories2_b1.jpg" src="images/collections/accessories2_b1.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-start wow fadeInUp" data-wow-delay="0s">
                                        ...
                                        <a href="shop-collection-sub.html" class="tf-btn btn-line collection-other-link fw-6"><span>Shop Collection</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item-v4 st-lg hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-sub.html" class="collection-image img-style radius-10 o-hidden">
                                        <img class="lazyload" data-src="images/collections/accessories2_b2.jpg" src="images/collections/accessories2_b2.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content text-start wow fadeInUp" data-wow-delay="0s">
        ...
        <section class="flat-spacing-25 pt_0">
            <div class="container">
                ...
                <div class="wrap-carousel">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product style-8">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/headphone-red2.jpg" src="images/products/headphone-red2.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/headphone-red.jpg" src="images/products/headphone-red.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product style-8">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/wireless-charging-black2.jpg" src="images/products/wireless-charging-black2.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/wireless-charging-white3.jpg" src="images/products/wireless-charging-white3.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                                                <span class="icon icon-heart"></span>
                                    ...
                                    <div class="card-product-info text-center">
                                        ...
                                        <ul class="list-color-product justify-content-center">
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">White</span>
                                                <span class="swatch-value bg_white"></span>
                                                <img class="lazyload" data-src="images/products/wireless-charging-white2.jpg" src="images/products/wireless-charging-white2.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/wireless-charging-black2.jpg" src="images/products/wireless-charging-black2.jpg" alt="image-product">
                                            </li>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product style-8">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/wireless-charging-black.jpg" src="images/products/wireless-charging-black.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/wireless-charging-white.jpg" src="images/products/wireless-charging-white.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="javascript:void(0);" class="box-icon bg_white wishlist btn-icon-action">
                    ...
                    <div class="nav-sw disable-line nav-next-slider nav-next-sell-1 box-icon w_46 round"><span class="icon icon-arrow-left"></span></div>
                    <div class="nav-sw disable-line nav-prev-slider nav-prev-sell-1 box-icon w_46 round"><span class="icon icon-arrow-right"></span></div>
        ...
        <section>
            <div class="container">
                <div class="wrapper-thumbs-testimonial-v2 flat-thumbs-testimonial flat-thumbs-testimonial-v2 bg-gradient-3">
                    <div class="box-left">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <p class="text text-white">
                                            Consider if the headphones support any advanced audio technologies, such as noise cancellation or surround sound, depending on your preferences. Comfort is crucial for long listening sessions
                                        </p>
                                        <div class="author box-author">
                                            <div class="box-img d-md-none">
                                                <img class="lazyload img-product" data-src="images/slider/accessories-tes1.png" src="images/slider/accessories-tes1.png" alt="image-product">
                                            </div>
                                            <div class="content">
                                                <div class="name text-white fw-6">Robert Smith</div>
                                                <a href="product-detail.html" class="metas link text-white">Purchase item : <span class="fw-6">3-in-1 Wireless Charging</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        ...
                                        <p class="text text-white">
                                            Love love love! This product is so easy to use!   I absolutely love the this product. High-quality headphones deliver a balanced and clear sound. Look for headphones with good bass, clear mids, and crisp highs.
                                        </p>
                                        <div class="author box-author">
                                            <div class="box-img d-md-none">
                                                <img class="lazyload img-product" data-src="images/slider/accessories-tes2.png" src="images/slider/accessories-tes2.png" alt="image-product">
                                            </div>
                                            <div class="content">
                                                <div class="name text-white fw-6">Robert Smith</div>
                                                <a href="product-detail.html" class="metas link text-white">Purchase item : <span class="fw-6">Beats Studio Buds</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="box-img item-2 hover-img radius-10 o-hidden">
                                        <div class="img-style">
                                            <img class="lazyload" data-src="images/slider/accessories-tes1.png" src="images/slider/accessories-tes1.png" alt="img-slider">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box-img item-2 hover-img radius-10 o-hidden">
                                        <div class="img-style">
                                            <img class="lazyload" data-src="images/slider/accessories-tes2.png" src="images/slider/accessories-tes2.png" alt="img-slider">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item-v2">
                                    <img class="lazyload" data-src="images/brand/dyson.svg" src="images/brand/dyson.svg"  alt="image-brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item-v2">
                                    <img class="lazyload" data-src="images/brand/sony.svg" src="images/brand/sony.svg"  alt="image-brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item-v2">
                                    <img class="lazyload" data-src="images/brand/samsung.svg" src="images/brand/samsung.svg"  alt="image-brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item-v2">
                                    <img class="lazyload" data-src="images/brand/oneplus.svg" src="images/brand/oneplus.svg" alt="image-brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item-v2">
                                    <img class="lazyload" data-src="images/brand/monster.svg" src="images/brand/monster.svg" alt="image-brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item-v2">
                                    <img class="lazyload" data-src="images/brand/sonos.svg" src="images/brand/sonos.svg" alt="image-brand">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay="0s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery1.jpg" src="images/shop/gallery/accessories-gallery1.jpg" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".1s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery2.jpg" src="images/shop/gallery/accessories-gallery2.jpg" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".2s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery3.jpg" src="images/shop/gallery/accessories-gallery3.jpg" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".3s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery4.jpg" src="images/shop/gallery/accessories-gallery4.jpg" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery5.jpg" src="images/shop/gallery/accessories-gallery5.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery6.jpg" src="images/shop/gallery/accessories-gallery6.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery7.jpg" src="images/shop/gallery/accessories-gallery7.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="images/shop/gallery/accessories-gallery8.jpg" src="images/shop/gallery/accessories-gallery8.jpg" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
