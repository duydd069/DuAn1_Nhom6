                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="public/client/assets/images/slider/fashion-slideshow-04.jpg" src="public/client/assets/images/slider/fashion-slideshow-04.jpg" alt="fashion-slideshow-01">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="public/client/assets/images/slider/fashion-slideshow-05.jpg" src="public/client/assets/images/slider/fashion-slideshow-05.jpg" alt="fashion-slideshow-02">
                            <div class="box-content">
                                <div class="container">
                    ...
                    <div class="item-1 collection-item large hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-women.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="public/client/assets/images/collections/collection-21.jpg" src="public/client/assets/images/collections/collection-21.jpg" alt="collection-img">
                            </a>
                    ...
                    <div class="item-2 collection-item large hover-img wow fadeInUp" data-wow-delay=".1s">
                        <div class="collection-inner">
                            <a href="shop-default.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="public/client/assets/images/collections/collection-22.jpg" src="public/client/assets/images/collections/collection-22.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                    ...
                    <div class="item-4 collection-item large hover-img wow fadeInUp" data-wow-delay="0s">
                        <div class="collection-inner">
                            <a href="shop-men.html" class="collection-image img-style rounded-0">
                                <img class="lazyload" data-src="public/client/assets/images/collections/collection-24.jpg" src="public/client/assets/images/collections/collection-24.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text">
                    <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                        <img class="lazyload" data-src="public/client/assets/images/collections/collection-25.jpg" src="public/client/assets/images/collections/collection-25.jpg" alt="collection-img">
                    </div>
          ...
          <div class="card-product">
            <div class="card-product-wrapper">
              <a href="product_detail.php?id=<?= htmlspecialchars($product['id']) ?>" class="product-img">
                <img class="lazyload img-product" data-src="images/products/<?= htmlspecialchars($product['image']) ?>" src="images/products/<?= htmlspecialchars($product['image']) ?>" alt="<?= htmlspecialchars($product['product_name']) ?>">
                <img class="lazyload img-hover" data-src="images/products/<?= htmlspecialchars($product['hover_image']) ?>" src="images/products/<?= htmlspecialchars($product['hover_image']) ?>" alt="<?= htmlspecialchars($product['product_name']) ?>">
              </a>
                                ...
                                <div class="banner-gr-item text-center hover-img">
                                    <div class="img-style">
                                        <a href="shop-default.html">
                                            <img class="lazyload" data-src="public/client/assets/images/shop/file/banner-gr-1.jpg" src="public/client/assets/images/shop/file/banner-gr-1.jpg" alt="banner-collection">
                                        </a>
                                    </div>
                                    <div class="content">
                                        <div class="title">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="london" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload" data-src="public/client/assets/images/shop/store/ourstore2.png" src="public/client/assets/images/shop/store/ourstore2.png" alt="store-img">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="paris" role="tabpanel">
                            <div class="widget-card-store align-items-center tf-grid-layout md-col-2">
                                ...
                                <div class="store-img">
                                    <img class="lazyload" data-src="public/client/assets/images/shop/store/ourstore3.png" src="public/client/assets/images/shop/store/ourstore3.png" alt="store-img">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="flat-spacing-1 wow fadeIn" data-wow-delay="0s">
            <div class="container">
                <div class="row-brand">
                    ...
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="public/client/assets/images/brand/brand-04.png" src="public/client/assets/images/brand/brand-04.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="public/client/assets/images/brand/brand-05.png" src="public/client/assets/images/brand/brand-05.png" alt="image-brand">
                    </div>
                    <div class="brand-item-v2 hover-img-brand">
                        <img class="lazyload" data-src="public/client/assets/images/brand/brand-06.png" src="public/client/assets/images/brand/brand-06.png" alt="image-brand">
                    </div>
                </div>        
            </div>
        </section>
