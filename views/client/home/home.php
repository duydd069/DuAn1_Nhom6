...
<div class="hover-sw-nav hover-sw-2"style="width: 800px; height: 1600px">
    ...
    $a["image"]
) ?>" alt="<?= htmlspecialchars($a["product_name"]) ?>">
                <img class=" img-hover" data-src="<?= htmlspecialchars(
                    $a["image"]
                ) ?>" src="<?= htmlspecialchars(
    $a["image"]
) ?>" alt="<?= htmlspecialchars($a["product_name"]) ?>">
...
<?php foreach ($a["colors"] as $color): ?>
                <li class="list-color-item color-swatch <?php if (
                  ...
                  <span class="tooltip"><?= htmlspecialchars(
                      $color["name"]
                  ) ?></span>
                  <span class="swatch-value" style="background-color: <?= htmlspecialchars(
                      $color["code"]
                  ) ?>;"></span>
                  <img class="lazyload" data-src="<?= htmlspecialchars(
                      $color["image"]
                  ) ?>" src="<?= htmlspecialchars(
    $color["image"]
) ?>" alt="<?= htmlspecialchars($a["product_name"]) ?>">
