...
<!-- Mirrored from themesflat.co/html/ecomus/product-inner-zoom.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:13:38 GMT -->
<head>
    <meta charset="utf-8">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide" data-color="brown">
                                                <a href="images/products/brown.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom-inner lazyload" data-zoom="images/products/brown.jpg" data-src="images/products/brown.jpg" src="images/products/brown.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- purple -->
                                            <div class="swiper-slide" data-color="purple">
                                                <a href="images/products/purple.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom-inner lazyload" data-zoom="images/products/purple.jpg" data-src="images/products/purple.jpg" src="images/products/purple.jpg" alt="img-product">
                                                </a>
                                            </div>
                                            <!-- light green -->
                                            <div class="swiper-slide" data-color="green">
                                                <a href="images/products/green.jpg" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                                    <img class="tf-image-zoom-inner lazyload" data-zoom="images/products/green.jpg" data-src="images/products/green.jpg" src="images/products/green.jpg" alt="img-product">
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="tf-product-info-wrap position-relative">
                                ...
                                <div class="tf-product-info-list">
                                    ...
                                    <div class="tf-product-info-variant-picker">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                ...
                                                <label class=" hover-tooltip radius-60 color-btn" data-color="purple" data-price="22" for="values-purple" data-value="Purple">
                                                    <span class="btn-checkbox bg_purple"></span>
                                                    <span class="tooltip">Purple</span>
                                                </label>
                                                <input id="values-green" type="radio" name="color1">
                                                <label class="hover-tooltip radius-60 color-btn" data-color="green" data-price="20" for="values-green" data-value="Light Green">
                                        ...
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values">
                                                <input type="radio" name="size1" id="values-m" checked>
                                                <label class="style-text size-btn" for="values-m" data-value="M">
                                                    <p>M</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-l">
                                                <label class="style-text size-btn" data-price="26" for="values-l" data-value="L">
                                                    <p>L</p>
                                                </label>
                                                <input type="radio" name="size1" id="values-xl">
                                                <label class="style-text size-btn" data-price="27" for="values-xl" data-value="XL">
                                                    <p>XL</p>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tf-product-info-buy-button">
                                        <form class="">
                                            <a href="javascript:void(0);" class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add to cart -&nbsp;</span><span class="tf-qty-price total-price">$25.00</span></a>
