<?php include_once "views/client/layout/header.php" ?>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="slider-effect wrap-slider">
                            <div class="content-left bg_light-grey-3">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="box-content">
                                                <h1 class="heading fade-item fade-item-1">Modern Dining<br> Furniture.</h1>
                                                <p class="desc fade-item fade-item-2">Special Offers You Can't Miss</p>
                            ...
                            <div class="img-slider">
                                <img class="lazyload" data-src="images/slider/009furniture-slideshow-01.jpg" src="images/slider/009furniture-slideshow-01.jpg" alt="fashion-slideshow">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide" lazy="true">
                        <div class="slider-effect wrap-slider">
                            <div class="content-left bg_light-blue-1">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="box-content">
                                                <h1 class="heading fade-item fade-item-1">Relaxing<br> room</h1>
                                                <p class="desc fade-item fade-item-2">Special Offers You Can't Miss</p>
                                                <a href="shop-collection-list.html" class="fade-item fade-item-3 tf-btn btn-light-icon animate-hover-btn btn-xl radius-3"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                            </div>
                                        </div>  
                            ...
                            <div class="img-slider">
                                <img class="lazyload" data-src="images/slider/009furniture-slideshow-02.jpg" src="images/slider/009furniture-slideshow-02.jpg" alt="fashion-slideshow">
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide" lazy="true">
                        <div class="slider-effect wrap-slider">
                            <div class="content-left bg_light-purple">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="box-content">
                                                <h1 class="heading fade-item fade-item-1">Luxurious<br> living room</h1>
                                                <p class="desc fade-item fade-item-2">Special Offers You Can't Miss</p>
                                                <a href="shop-collection-list.html" class="fade-item fade-item-3 tf-btn btn-light-icon animate-hover-btn btn-xl radius-3"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                            </div>
                                        </div>  
                            ...
                            <div class="img-slider">
                                <img class="lazyload" data-src="images/slider/009furniture-slideshow-03.jpg" src="images/slider/009furniture-slideshow-03.jpg" alt="fashion-slideshow">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="masonry-layout-v4 wow fadeInUp" data-wow-delay="0s">
                    <div class="item-1 collection-item-v2 hover-img">
                        <a href="shop-collection-sub.html" class="collection-inner">
                            <div class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/009furniture-banner-01.jpg" src="images/collections/009furniture-banner-01.jpg" alt="collection-img">
                            </div>
                    ...
                    <div class="item-2 collection-item-v2 hover-img">
                        <a href="shop-collection-sub.html" class="collection-inner">
                            <div class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/009furniture-banner-02.jpg" src="images/collections/009furniture-banner-02.jpg" alt="collection-img">
                            </div>
                    ...
                    <div class="item-3 collection-item-v2 hover-img">
                        <a href="shop-collection-sub.html" class="collection-inner">
                            <div class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/009furniture-banner-03.jpg" src="images/collections/009furniture-banner-03.jpg" alt="collection-img">
                            </div>
                            <div class="collection-content justify-content-end">
                                <div class="bottom wow fadeInUp" data-wow-delay="0s">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="collection-item large hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-list.html" class="collection-image img-style rounded-0">
                                        <img class="lazyload" data-src="images/collections/009furniture-banner-04.jpg" src="images/collections/009furniture-banner-04.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content">
                                        <a href="shop-collection-list.html" class="tf-btn collection-title hover-icon"><span>Furniture</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item large hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-list.html" class="collection-image img-style rounded-0">
                                        <img class="lazyload" data-src="images/collections/009furniture-banner-05.jpg" src="images/collections/009furniture-banner-05.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content">
                                        <a href="shop-collection-list.html" class="tf-btn collection-title hover-icon"><span>Lighting</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item large hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-list.html" class="collection-image img-style rounded-0">
                                        <img class="lazyload" data-src="images/collections/009furniture-banner-06.jpg" src="images/collections/009furniture-banner-06.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content">
                                        <a href="shop-collection-list.html" class="tf-btn collection-title hover-icon"><span>Outdoor</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item large hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-list.html" class="collection-image img-style rounded-0">
                                        <img class="lazyload" data-src="images/collections/009furniture-banner-07.jpg" src="images/collections/009furniture-banner-07.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content">
                                        <a href="shop-collection-list.html" class="tf-btn collection-title hover-icon"><span>Kitchen</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item large hover-img">
                                <div class="collection-inner">
                                    <a href="shop-collection-list.html" class="collection-image img-style rounded-0">
                                        <img class="lazyload" data-src="images/collections/009furniture-banner-08.jpg" src="images/collections/009furniture-banner-08.jpg" alt="collection-img">
                                    </a>
                                    <div class="collection-content">
                                        <a href="shop-collection-list.html" class="tf-btn collection-title hover-icon"><span>Decor</span><i class="icon icon-arrow1-top-left"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- /Categories -->
        <!-- Banner collection -->
        <section class="banner-collection-men-wrap banner-parallax" style="background-image: url(images/slider/furniture-banner-collection.jpg);">
            <div class="box-content">
                <div class="container">
                    <a href="shop-collection-sub.html" class="card-box text-md-start text-center rounded-0">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0s">
                            <button class="tf-btn style-2 btn-fill animate-hover-btn"><span>Shop Collection</span></button>   
                        </div>
                    </a>  
                </div>
            </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/lamp-black.jpg" src="images/products/lamp-black.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/lamp-black.jpg" src="images/products/lamp-black.jpg" alt="image-product">
                                        </a>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">AJ Wall Sconce</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-1.jpg" src="images/products/furniture-1.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-1.jpg" src="images/products/furniture-1.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Brasilia Lounge Chair</a>
                                        <span class="price">$982.00</span>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-2.jpg" src="images/products/furniture-2.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-3.jpg" src="images/products/furniture-3.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Lina Swivel Chair</a>
                                        <span class="price">$3,600.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Grey</span>
                                                <span class="swatch-value bg_grey"></span>
                                                <img class="lazyload" data-src="images/products/furniture-2.jpg" src="images/products/furniture-2.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Cream</span>
                                                <span class="swatch-value bg_cream"></span>
                                                <img class="lazyload" data-src="images/products/furniture-3.jpg" src="images/products/furniture-3.jpg" alt="image-product">
                                            </li>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-6.jpg" src="images/products/furniture-6.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-7.jpg" src="images/products/furniture-7.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">MR Chaise</a>
                                        <span class="price">$1,999.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Light Grey</span>
                                                <span class="swatch-value bg_light-grey"></span>
                                                <img class="lazyload" data-src="images/products/furniture-6.jpg" src="images/products/furniture-6.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/furniture-7.jpg" src="images/products/furniture-7.jpg" alt="image-product">
                                            </li>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-4.jpg" src="images/products/furniture-4.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-5.jpg" src="images/products/furniture-5.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">MG501 Cuba Lounge Chair, Paper Cord</a>
                                        <span class="price">
                                            <span class="old-price">$1,366.00</span>
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/furniture-4.jpg" src="images/products/furniture-4.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Cream</span>
                                                <span class="swatch-value bg_cream"></span>
                                                <img class="lazyload" data-src="images/products/furniture-5.jpg" src="images/products/furniture-5.jpg" alt="image-product">
                                            </li>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-8.jpg" src="images/products/furniture-8.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-9.jpg" src="images/products/furniture-9.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Scissor Chair</a>
                                        <span class="price">Form $2,755.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Beige</span>
                                                <span class="swatch-value bg_beige"></span>
                                                <img class="lazyload" data-src="images/products/furniture-8.jpg" src="images/products/furniture-8.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Navy</span>
                                                <span class="swatch-value bg_navy"></span>
                                                <img class="lazyload" data-src="images/products/furniture-9.jpg" src="images/products/furniture-9.jpg" alt="image-product">
                                            </li>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-10.jpg" src="images/products/furniture-10.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-11.jpg" src="images/products/furniture-11.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                        ...
                                        <div class="on-sale-wrap text-end">
                                            <div class="on-sale-item pre-order">Pre-Oder</div>
                                        </div>
                                    </div>
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Soborg Model 3052 Dining Chair</a>
                                        <span class="price">
                                            <span class="old-price">$1,695.00</span>
                                            <span class="new-price">$1,356.00</span>
                                        </span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/furniture-10.jpg" src="images/products/furniture-10.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Copper</span>
                                                <span class="swatch-value bg_copper"></span>
                                                <img class="lazyload" data-src="images/products/furniture-11.jpg" src="images/products/furniture-11.jpg" alt="image-product">
                                            </li>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/furniture-12.jpg" src="images/products/furniture-12.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/furniture-13.jpg" src="images/products/furniture-13.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn absolute-2">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Womb Ottoman</a>
                                        <span class="price">
                                            <span class="old-price">$1,695.00</span>
                                            <span class="new-price">$1,356.00</span>
                                        </span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                ...
                                                <img class="lazyload" data-src="images/products/furniture-12.jpg" src="images/products/furniture-12.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/furniture-13.jpg" src="images/products/furniture-13.jpg" alt="image-product">
                                            </li>
