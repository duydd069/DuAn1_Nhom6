<?php include_once "views/client/layout/header.php" ?>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" lazy="true">
                            <div class="wrap-slider">
                                <img class="lazyload" data-src="images/slider/slide-gocery1.jpg" src="images/slider/slide-gocery1.jpg" alt="hp-slideshow-01">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="wrap-slider row-end">
                                <img class="lazyload" data-src="images/slider/slide-gocery2.jpg" src="images/slider/slide-gocery2.jpg" alt="hp-slideshow-02">
                                <div class="box-content">
                                    <div class="container">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="wrap-slider">
                                <img class="lazyload" data-src="images/slider/slide-gocery3.jpg" src="images/slider/slide-gocery3.jpg" alt="hp-slideshow-03">
                                <div class="box-content">
                                    <div class="container">
                ...
                <div dir="ltr" class="swiper tf-sw-recent wow fadeInUp" data-preview="6" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="30" data-space="15" data-pagination="2" data-pagination-md="3" data-pagination-lg="3">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="collection-item-circle has-bg has-bg-2 hover-img">
                                <a href="shop-default.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/vegetable.png" alt="collection-img" src="images/collections/vegetable.png">
                                </a>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item-circle has-bg has-bg-2 hover-img">
                                <a href="shop-default.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/dairy.png" alt="collection-img" src="images/collections/dairy.png">
                                </a>
                                <div class="collection-content text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item-circle has-bg has-bg-2 hover-img">
                                <a href="shop-default.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/package-foods.png" alt="collection-img" src="images/collections/package-foods.png">
                                </a>
                                <div class="collection-content text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item-circle has-bg has-bg-2 hover-img">
                                <a href="shop-default.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/beverage.png" alt="collection-img" src="images/collections/beverage.png">
                                </a>
                                <div class="collection-content text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item-circle has-bg has-bg-2 hover-img">
                                <a href="shop-default.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/meat.png" alt="collection-img" src="images/collections/meat.png">
                                </a>
                                <div class="collection-content text-center">
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item-circle has-bg has-bg-2 hover-img">
                                <a href="shop-default.html" class="collection-image img-style">
                                    <img class="lazyload" data-src="images/collections/fruit.png" alt="collection-img" src="images/collections/fruit.png">
                                </a>
                                <div class="collection-content text-center">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="collection-item-v4 hover-img">
                                <a href="product-detail.html" class="collection-inner">
                                    <div class="collection-image radius-10 img-style">
                                        <img class="lazyload" data-src="images/collections/banner-collection-grocery.jpg" src="images/collections/banner-collection-grocery.jpg" alt="collection-img">
                                    </div>
                                    <div class="collection-content text-start">
                                        <div class="bottom wow fadeInUp" data-wow-delay="0s">
                                            ...
                                            <button class="tf-btn style-3 btn-color-5 radius-60 animate-hover-btn">Shop now</button>
                                        </div>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="collection-item-v4 hover-img">
                                <a href="product-detail.html" class="collection-inner">
                                    <div class="collection-image radius-10 img-style">
                                        <img class="lazyload" data-src="images/collections/banner-collection-grocery2.jpg" src="images/collections/banner-collection-grocery2.jpg" alt="collection-img">
                                    </div>
                                    <div class="collection-content text-start">
                                        <div class="bottom wow fadeInUp" data-wow-delay="0s">
                                            ...
                                            <button class="tf-btn style-3 btn-color-6 radius-60 animate-hover-btn">Shop now</button>
                                        </div>
                                    </div>
                                </a>
                            </div>
        ...
        <section class="flat-spacing-8">
            <div class="container">
                ...
                <div dir="ltr" class="swiper tf-sw-product-sell" data-preview="3" data-tablet="3" data-mobile="1" data-space-lg="30" data-space-md="15" data-pagination="1" data-pagination-md="3" data-pagination-lg="3">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product style-8 border-0 bg_grey-14 lg">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="images/products/grocery-1.jpg" src="images/products/grocery-1.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/grocery-2.jpg" src="images/products/grocery-2.jpg" alt="image-product">
                                    </a>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <span class="price"><span class="old-price text_primary">$40.25</span> <span class="new-price">$30.25</span></span>
                                    <div class="pr-stock">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product style-8 border-0 bg_grey-14 lg">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="images/products/grocery-3.jpg" src="images/products/grocery-3.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/grocery-4.jpg" src="images/products/grocery-4.jpg" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                                ...
                                <div class="card-product-info">
                                    ...
                                    <span class="price"><span class="old-price text_primary">$4.70</span> <span class="new-price">$3.70</span></span>
                                    <div class="pr-stock">
                                        <div class="pr-stock-status d-flex justify-content-between align-items-center">
                                            <div class="pr-stock-available">
                                                <span class="pr-stock-label fs-12 fw-6">Available: </span>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product style-8 border-0 bg_grey-14 lg">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" data-src="images/products/grocery-5.jpg" src="images/products/grocery-5.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="images/products/grocery-6.jpg" src="images/products/grocery-6.jpg" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tf-icon-box text-center">
                                            ...
                                            <div class="content">
                                                ...
                                                <p>Shop everyday staples, small-batch finds, and <br> community favorites. From meat and seafood alternatives to snacks and candy - we’ve got your fridge, freezer and pantry covered.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text img-text-3 img-text-3-style-2">
                    <div class="tf-image wow fadeInUp" data-wow-delay="0s">
                        <div class="grid-img-group">
                            <div class="box-img item-1 hover-img tf-image-wrap">
                                <div class="img-style">
                                    <img class="lazyload" data-src="images/collections/img-w-text-grocery1.jpg" src="images/collections/img-w-text-grocery1.jpg" alt="img-slider">
                                </div>
                            </div>
                            <div class="box-img item-2 hover-img tf-image-wrap">
                                <div class="img-style">
                                    <img class="lazyload" data-src="images/collections/img-w-text-grocery2.jpg" src="images/collections/img-w-text-grocery2.jpg" alt="img-slider">
                                </div>
                            </div>
                            <div class="box-img item-3 hover-img tf-image-wrap">
                                <div class="img-style">
                                    <img class="lazyload" data-src="images/collections/img-w-text-grocery3.jpg" src="images/collections/img-w-text-grocery3.jpg" alt="img-slider">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                        ...
                        <p class="desc fade-item fade-item-2">Delivered every month! Perfect for your favorite vegan or anyone you want <br> to introduce to the best better-for-you foods out there.</p>
