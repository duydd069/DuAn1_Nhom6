<?php include_once "views/client/layout/header.php" ?>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="images/slider/slider-activewear-1.jpg" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1 font-young-serif fw-6">Living<br>on a cloud.</h1>
                                    <p class="fade-item fade-item-2">You have to feel it to believe it.</p>
                                    <div class="fade-item fade-item-3 ">
                                        <a href="shop-default.html" class="tf-btn btn-light-icon animate-hover-btn btn-xl radius-60"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="images/slider/slider-activewear-2.jpg" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1 font-young-serif fw-6">Unleash<br>your strength</h1>
                                    <p class="fade-item fade-item-2">You have to feel it to believe it.</p>
                                    <div class="fade-item fade-item-3 ">
                                        <a href="shop-default.html" class="tf-btn btn-light-icon animate-hover-btn btn-xl radius-60"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="wrap-slider">
                            <img src="images/slider/slider-activewear-3.jpg" alt="fashion-slideshow">
                            <div class="box-content">
                                <div class="container">
                                    <h1 class="fade-item fade-item-1 font-young-serif fw-6">Living<br>on a cloud.</h1>
                                    <p class="fade-item fade-item-2">You have to feel it to believe it.</p>
                                    <div class="fade-item fade-item-3 ">
                                        <a href="shop-default.html" class="tf-btn btn-light-icon border-line animate-hover-btn btn-xl radius-60"><span>Shop collection</span><i class="icon icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="tf-icon-box-v2">
                                ...
                                <div class="title font-young-serif fs-14">Free Shipping on Orders Over $120</div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tf-icon-box-v2">
                                <span class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="" width="30" height="22" viewBox="0 0 30 22"><path d="M0 0H29.4643V22H0V0ZM27.5 1.9643H1.9643V20.0357H27.5V1.9643ZM0 4.97617H29.4643V11.9167H0V4.97617ZM27.5 6.94047H1.9643V9.95238H27.5V6.94047Z"></path></svg>
                                </span>
                                <div class="title font-young-serif fs-14">Versatile and Adaptable Payment Solutions</div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="tf-icon-box-v2">
                                ...
                                <div class="title font-young-serif fs-14">14-Day Hassle-Free Return Policy</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-full">
                <div class="masonry-layout-v4 style-2 wow fadeInUp" data-wow-delay="0s">
                    <div class="item-1 collection-item style-2 hover-img">
                        <div class="collection-inner">
                            <a href="shop-collection-sub.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/cls-activewear1.jpg" src="images/collections/cls-activewear1.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-collection-sub.html" class="tf-btn collection-title hover-icon font-young-serif text-22 rounded-full"><span>T-shirt & Top</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-2 collection-item style-2 hover-img">
                        <div class="collection-inner">
                            <a href="shop-collection-sub.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/cls-activewear2.jpg" src="images/collections/cls-activewear2.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-collection-sub.html" class="tf-btn collection-title hover-icon font-young-serif text-22 rounded-full"><span>Leggings</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item-3 collection-item style-2 hover-img">
                        <div class="collection-inner">
                            <a href="shop-collection-sub.html" class="collection-image img-style">
                                <img class="lazyload" data-src="images/collections/cls-activewear3.jpg" src="images/collections/cls-activewear3.jpg" alt="collection-img">
                            </a>
                            <div class="collection-content">
                                <a href="shop-collection-sub.html" class="tf-btn collection-title hover-icon font-young-serif text-22 rounded-full"><span>Sport Bras</span><i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </div>
                    </div> 
                </div>
            ...
            <div class="container">
                <div class="flat-title mb_1 flex-row justify-content-between px-0">
                    ...
                    <div class="box-sw-navigation">
                        <div class="nav-sw round nav-next-brand nav-next-slider"><span class="icon icon-arrow1-left"></span></div>
                        <div class="nav-sw round nav-prev-brand nav-prev-slider"><span class="icon icon-arrow1-right"></span></div>
                    </div>
                </div>
                <div class="hover-sw-nav hover-sw-3">
                    <div dir="ltr" class="swiper tf-sw-brand rounded-0 border-0 wrap-sw-over" data-loop="false" data-play="false" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="15">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/brown-11.jpg" src="images/products/brown-11.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/brown-12.jpg" src="images/products/brown-12.jpg" alt="image-product">
                                        </a>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Crossover Leggings</a>
                                        <span class="price">$38.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Brown</span>
                                                <span class="swatch-value bg_brown"></span>
                                                <img class="lazyload" data-src="images/products/brown-11.jpg" src="images/products/brown-11.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-24.jpg" src="images/products/black-24.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Pink</span>
                                                <span class="swatch-value bg_pink"></span>
                                                <img class="lazyload" data-src="images/products/pink-4.jpg" src="images/products/pink-4.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Purple</span>
                                                <span class="swatch-value bg_purple"></span>
                                                <img class="lazyload" data-src="images/products/purple-2.jpg" src="images/products/purple-2.jpg" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/blue-5.jpg" src="images/products/blue-5.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/blue-6.jpg" src="images/products/blue-6.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        ...
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                ...
                                                <img class="lazyload" data-src="images/products/blue-5.jpg" src="images/products/blue-5.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-25.jpg" src="images/products/black-25.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Red</span>
                                                <span class="swatch-value bg_red"></span>
                                                <img class="lazyload" data-src="images/products/red.jpg" src="images/products/red.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Brown</span>
                                                <span class="swatch-value bg_brown"></span>
                                                <img class="lazyload" data-src="images/products/brown-13.jpg" src="images/products/brown-13.jpg" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>   
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/white-17.jpg" src="images/products/white-17.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/white-18.jpg" src="images/products/white-18.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Ruched Strappy Sports Bra</a>
                                        <span class="price">$38.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">White</span>
                                                <span class="swatch-value bg_white"></span>
                                                <img class="lazyload" data-src="images/products/white-17.jpg" src="images/products/white-17.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-2.jpg" src="images/products/green-2.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-26.jpg" src="images/products/black-26.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Pink</span>
                                                <span class="swatch-value bg_pink"></span>
                                                <img class="lazyload" data-src="images/products/pink-5.jpg" src="images/products/pink-5.jpg" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>    
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/grey-3.jpg" src="images/products/grey-3.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/grey-4.jpg" src="images/products/grey-4.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Vital Seamless 2.0 V Neck Sports Bra</a>
                                        <span class="price">$38.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Grey</span>
                                                <span class="swatch-value bg_grey"></span>
                                                <img class="lazyload" data-src="images/products/grey-3.jpg" src="images/products/grey-3.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-3.jpg" src="images/products/green-3.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-27.jpg" src="images/products/black-27.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Light Green</span>
                                                <span class="swatch-value bg_light-green"></span>
                                                <img class="lazyload" data-src="images/products/light-green-6.jpg" src="images/products/light-green-6.jpg" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>  
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/white-19.jpg" src="images/products/white-19.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/white-20.jpg" src="images/products/white-20.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Adapt Fleck Seamless Long Sleever Crop Top</a>
                                        <span class="price">$38.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">White</span>
                                                <span class="swatch-value bg_white"></span>
                                                <img class="lazyload" data-src="images/products/white-19.jpg" src="images/products/white-19.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-28.jpg" src="images/products/black-28.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Brown</span>
                                                <span class="swatch-value bg_brown"></span>
                                                <img class="lazyload" data-src="images/products/brown-14.jpg" src="images/products/brown-14.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-4.jpg" src="images/products/green-4.jpg" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>  
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="card-product">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                                            <img class="lazyload img-product" data-src="images/products/black-29.jpg" src="images/products/black-29.jpg" alt="image-product">
                                            <img class="lazyload img-hover" data-src="images/products/black-30.jpg" src="images/products/black-30.jpg" alt="image-product">
                                        </a>
                                        <div class="list-product-btn">
                                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                <span class="icon icon-bag"></span>
                                    ...
                                    <div class="card-product-info">
                                        <a href="product-detail.html" class="title link">Vital Seamless 2.0 Crop Top</a>
                                        <span class="price">$100.00</span>
                                        <ul class="list-color-product">
                                            <li class="list-color-item color-swatch active">
                                                <span class="tooltip">Black</span>
                                                <span class="swatch-value bg_dark"></span>
                                                <img class="lazyload" data-src="images/products/black-29.jpg" src="images/products/black-29.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Green</span>
                                                <span class="swatch-value bg_green"></span>
                                                <img class="lazyload" data-src="images/products/green-5.jpg" src="images/products/green-5.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Blue</span>
                                                <span class="swatch-value bg_blue-2"></span>
                                                <img class="lazyload" data-src="images/products/blue-7.jpg" src="images/products/blue-7.jpg" alt="image-product">
                                            </li>
                                            <li class="list-color-item color-swatch">
                                                <span class="tooltip">Light Blue</span>
                                                <span class="swatch-value bg_light-blue"></span>
                                                <img class="lazyload" data-src="images/products/light-blue-4.jpg" src="images/products/light-blue-4.jpg" alt="image-product">
                                            </li>
                                        </ul>
                                    </div>
                                </div>  
                    ...
                    <div class="nav-sw nav-next-slider nav-next-brand box-icon w_46 round"><span class="icon icon-arrow-left"></span></div>
                    <div class="nav-sw nav-prev-slider nav-prev-brand box-icon w_46 round"><span class="icon icon-arrow-right"></span></div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="tf-hero-image-liquid radius-10 o-hidden banner-countdown-v2">
                    <img class="lazyload" data-src="images/slider/banner-countdown-2.png" src="images/slider/banner-countdown-2.png" alt="img-banner" loading="lazy">
                    <div class="box-content">
                        <h2 class="heading font-young-serif">Bra Spotlight</h2>
                        <p class="fs-14">Let's go from the top.</p>
                        <div class="tf-countdown">
                            <div class="js-countdown" data-timer="8007500" data-labels="Days,Hours,Mins,Secs"></div>
                        </div>
                        <a href="shop-default.html" class="tf-btn btn-fill btn-md animate-hover-btn radius-60">Shop now - $129</a>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="flat-animate-tab">
                    <ul class="widget-tab-3 style-3 d-flex justify-content-center wow fadeInUp" data-wow-delay="0s" role="tablist">
                        <li class="nav-tab-item" role="presentation">   
                            <a href="#men" class="active" data-bs-toggle="tab">Men</a>
                        </li>
                        <li class="nav-tab-item" role="presentation">
                            <a href="#women" data-bs-toggle="tab">Women</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane hover-sw-nav active show" id="men" role="tabpanel">
                            <div class="tf-sw-product-sell wrap-sw-over" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="15" data-pagination="2" data-pagination-md="2" data-pagination-lg="1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card-product">
                                            <div class="card-product-wrapper">
                                                <a href="product-detail.html" class="product-img">
                                                    <img class="lazyload img-product" data-src="images/products/brown-15.jpg" src="images/products/brown-15.jpg" alt="image-product">
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-15.jpg" src="images/products/brown-15.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Green</span>
                                                        <span class="swatch-value bg_green"></span>
                                                        <img class="lazyload" data-src="images/products/green-6.jpg" src="images/products/green-6.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Red</span>
                                                        <span class="swatch-value bg_red"></span>
                                                        <img class="lazyload" data-src="images/products/sports-clothing.jpg" src="images/products/sports-clothing.jpg" alt="image-product">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Grey</span>
                                                        <span class="swatch-value bg_grey"></span>
                                                        <img class="lazyload" data-src="images/products/sports-clothing-3.jpg" src="images/products/sports-clothing-3.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Black</span>
                                                        <span class="swatch-value bg_dark"></span>
                                                        <img class="lazyload" data-src="images/products/black-31.jpg" src="images/products/black-31.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Blue</span>
                                                        <span class="swatch-value bg_blue-2"></span>
                                                        <img class="lazyload" data-src="images/products/blue-8.jpg" src="images/products/blue-8.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-16.jpg" src="images/products/brown-16.jpg" alt="image-product">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Blue</span>
                                                        <span class="swatch-value bg_blue-2"></span>
                                                        <img class="lazyload" data-src="images/products/sports-clothing-6.jpg" src="images/products/sports-clothing-6.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Grey</span>
                                                        <span class="swatch-value bg_grey"></span>
                                                        <img class="lazyload" data-src="images/products/grey-5.jpg" src="images/products/grey-5.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-17.jpg" src="images/products/brown-17.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Light Blue</span>
                                                        <span class="swatch-value bg_light-blue"></span>
                                                        <img class="lazyload" data-src="images/products/light-blue-5.jpg" src="images/products/light-blue-5.jpg" alt="image-product">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card-product">
                                            ...
                                            <div class="card-product-info">
                                                <a href="product-detail.html" class="title link">Crest Long Sleeve T-Shirt</a>
                                                <span class="price">$38.00</span>
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Grey</span>
                                                        <span class="swatch-value bg_grey"></span>
                                                        <img class="lazyload" data-src="images/products/sports-clothing-7.jpg" src="images/products/sports-clothing-7.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">White</span>
                                                        <span class="swatch-value bg_white"></span>
                                                        <img class="lazyload" data-src="images/products/white-21.jpg" src="images/products/white-21.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-18.jpg" src="images/products/brown-18.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Black</span>
                                                        <span class="swatch-value bg_dark"></span>
                                                        <img class="lazyload" data-src="images/products/black-32.jpg" src="images/products/black-32.jpg" alt="image-product">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-product-info">
                                                ...
                                                <ul class="list-color-product">
                                                    <li class="list-color-item color-swatch active">
                                                        <span class="tooltip">Light Blue</span>
                                                        <span class="swatch-value bg_light-blue"></span>
                                                        <img class="lazyload" data-src="images/products/t-shirt-15.jpg" src="images/products/t-shirt-15.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">White</span>
                                                        <span class="swatch-value bg_white"></span>
                                                        <img class="lazyload" data-src="images/products/white-22.jpg" src="images/products/white-22.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Green</span>
                                                        <span class="swatch-value bg_green"></span>
                                                        <img class="lazyload" data-src="images/products/green-7.jpg" src="images/products/green-7.jpg" alt="image-product">
                                                    </li>
                                                    <li class="list-color-item color-swatch">
                                                        <span class="tooltip">Brown</span>
                                                        <span class="swatch-value bg_brown"></span>
                                                        <img class="lazyload" data-src="images/products/brown-19.jpg" src="images/products/brown-19.jpg" alt="image-product">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="tab-pane hover-sw-nav" id="women" role="tabpanel">
                            <div class="tf-sw-product-sell-1 wrap-sw-over" data-preview="4" data-tablet="3" data-mobile="2" data-space-lg="30" data-space-md="15" data-pagination="2" data-pagination-md="2" data-pagination-lg="1">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="card-product">
                                            <div class="card-product-wrapper">
                        ...
                        <div class="flat-lookbook-v3 d-flex">
                                    ...
                                    <div class="inner-sw-lookbook">
                                        ...
                                        <form>
                                            <div dir="ltr" class="swiper tf-lookbook " data-preview="3" data-tablet="1" data-mobile="1" data-space-lg="0" data-space-md="0">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide" lazy="true">
                                                        <div class="tf-bundle-product-item type-lg">
                                                            ...
                                                            <div class="tf-product-bundle-infos">
                                                                <a href="product-detail.html" class="tf-product-bundle-title fs-16">Ruched Strappy Sports Bra</a>
                                                    ...
                                                    <div class="swiper-slide" lazy="true">
                                                        <div class="tf-bundle-product-item type-lg">
                                                            ...
                                                            <div class="tf-product-bundle-infos">
                                                                <a href="product-detail.html" class="tf-product-bundle-title fs-16">Pocket Shorts</a>
                                                                <div class="tf-product-bundle-price">
                                                                    <div class="price fs-16">$38.00</div>
                                                                </div>
                                                                <div class="tf-product-bundle-variant position-relative">
                                                    ...
                                                    <div class="swiper-slide" lazy="true">
                                                        <div class="tf-bundle-product-item type-lg">
                                                            ...
                                                            <div class="tf-product-bundle-infos">
                                                                <span class="tf-product-bundle-title fs-16">Crossover Leggings</span>
                                                                <div class="tf-product-bundle-price">
                                                                    <div class="price fs-16">$38.00</div>
                                                                </div>
                                                                <div class="tf-product-bundle-variant position-relative">
                                                ...
                                                <div class="sw-dots style-2 sw-pagination-lookbook justify-content-center d-xl-none"></div> 
                                            </div>
                                            <button type="submit" class="tf-btn justify-content-center style-2 btn-fill radius-3 animate-hover-btn">Add selected to cart - $114.00 USD</button>
                                        </form>
                                    </div>
                                </div>  
                            </div>
                            <div class="col-right w-50">
                                <div class="wrap-lookbook lookbook-sw">
                                    <div class="image">
                                        <img class="lazyload" data-src="images/shop/file/lb-activewear.jpg" src="images/shop/file/lb-activewear.jpg" alt="collection-img">
                                    </div>
            ...
            <div class="container">
                <div class="tf-grid-layout md-col-2 tf-img-with-text style-5">
                    <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                        <img class="lazyload" data-src="images/collections/banner-collection-activewear.jpg" src="images/collections/banner-collection-activewear.jpg" alt="collection-img">
                    </div>
                    <div class="tf-content-wrap wow fadeInUp" data-wow-delay="0s">
                        <div class="sub-heading fw-7">LEAVE YOUR MARK</div>
                        <div class="heading font-young-serif">We're Ecfriend Collective</div>
                        <p class="description text_black-2 fs-14">Since our inception in late 2012, ECfriend has had one intention;
                            to help build resilient human beings through performance, innovation, sustainability and functionality.</p>
                        <a href="shop-collection-list.html" class="tf-btn style-2 btn-fill btn-icon rounded-full animate-hover-btn">Learn more <i class="icon icon-arrow1-top-left"></i></a>
                    </div>
                </div>
            </div>
        </section>
                                        ...
                                        <div class="icon w-50 no-border">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="51" height="51" viewBox="0 0 51 51" fill="none">
                                                <g clip-path="url(#clip0_8522_10)">
                                                  <path d="M25.5035 7.58789C32.2077 10.0444 37.0184 16.4927 37.0184 24.0669C37.0184 31.6411 32.1565 38.0382 25.4523 40.4436C18.697 37.9871 13.9375 31.5899 13.9375 24.0157C13.9375 16.4415 18.7993 10.0444 25.5035 7.58789Z" fill="white"></path>
                                                  <path d="M25.4524 41.5694L25.0942 41.4671C17.7759 38.8059 12.9141 31.7946 12.9141 24.0669C12.9141 16.2879 17.8782 9.32786 25.1966 6.71783L25.5548 6.61548L25.8619 6.66666C33.1802 9.32786 38.042 16.3391 38.042 24.0669C38.042 31.8458 33.0778 38.8059 25.8107 41.4159L25.4524 41.5694ZM25.5036 8.71374C19.2088 11.1191 14.9611 17.2603 14.9611 24.0157C14.9611 30.7711 19.1577 36.9123 25.4524 39.3688C31.7472 36.9123 35.9437 30.8222 35.9949 24.0669C35.9949 17.3115 31.7984 11.1702 25.5036 8.71374Z" fill="#282D33"></path>
                                                  <path d="M31.8005 31.1292C30.3164 33.6881 28.0646 35.684 25.4545 36.9122C20.4904 34.6093 17.215 29.5427 17.2662 24.0156C17.2662 21.5079 17.9315 19.1026 19.1598 16.9532C20.6439 14.3943 22.8957 12.3984 25.5569 11.1702C30.5211 13.4731 33.7964 18.5397 33.7452 24.0668C33.6941 26.5233 33.0288 28.9798 31.8005 31.1292Z" fill="#5EB4E7"></path>
                                                  <path d="M24.4219 39.4629L24.4858 7.57959L26.5329 7.58368L26.469 39.467L24.4219 39.4629Z" fill="#282D33"></path>
                                                  <path d="M25.4064 45.4589C24.8434 45.4589 24.3828 44.9983 24.3828 44.4354V40.4947C24.3828 39.9318 24.8434 39.4712 25.4064 39.4712C25.9693 39.4712 26.4299 39.9318 26.4299 40.4947V44.4354C26.4299 44.9983 25.9693 45.4589 25.4064 45.4589Z" fill="#282D33"></path>
                                                  <path d="M16.3984 16.1825L17.7823 14.6738L25.7403 21.9737L24.3565 23.4824L16.3984 16.1825Z" fill="#282D33"></path>
                                                  <path d="M13.6016 24.2189L14.9854 22.7102L25.7346 32.57L24.3508 34.0787L13.6016 24.2189Z" fill="#282D33"></path>
                                                  <path d="M25.2266 21.9822L33.2174 14.7151L34.595 16.2299L26.6042 23.4971L25.2266 21.9822Z" fill="#282D33"></path>
                                                  <path d="M25.1058 32.5888L35.8991 22.7874L37.2747 24.3022L26.4815 34.1036L25.1058 32.5888ZM4.06337 38.857C-2.12906 28.9286 -0.644925 16.1855 7.64576 7.89484C17.4206 -1.87998 33.3366 -1.87998 43.1115 7.89484L41.6785 9.3278C32.6713 0.32063 18.0859 0.32063 9.07872 9.3278C1.50451 16.902 0.122731 28.6216 5.80339 37.7311L4.06337 38.857Z" fill="#282D33"></path>
                                                  <path d="M43.3649 9.99304H36.4049V7.94596H41.3179V3.03296H43.3649V9.99304ZM25.5553 50.5253C19.107 50.5253 12.7099 48.0688 7.79688 43.207L9.22983 41.774C18.237 50.7812 32.8225 50.7812 41.8296 41.774C49.4038 34.1998 50.7344 22.1732 45.0026 13.166L46.7426 12.0913C52.9862 21.9173 51.5021 35.0186 43.2626 43.2581C38.4008 48.12 31.9525 50.5253 25.5553 50.5253Z" fill="#282D33"></path>
                                                  <path d="M9.64083 48.0177H7.59375V41.0576H14.5538V43.1047H9.64083V48.0177Z" fill="#282D33"></path>
                                                </g>
                                                <defs>
                                                  <clipPath id="clip0_8522_10">
                                                    <rect width="50.3071" height="50" fill="white" transform="translate(0.273438 0.525391)"></rect>
                                                  </clipPath>
                                                </defs>
                                            </svg>
                                        </div>
        ...
        <!-- /iconbox -->
        <!-- Testimonial -->
        <section class="bg_grey-7 flat-spacing-18">
            <div class="container">
                <div class="wrap-carousel">
                    <div dir="ltr" class="swiper tf-sw-testimonial" data-preview="2" data-tablet="2" data-mobile="1" data-space-lg="30" data-space-md="15">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear1.jpg" alt="" src="images/item/tes-wear1.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="author">
                                            <div class="name">Anna Lan</div>
                                            <div class="metas">Customer from Japan</div>
                                        </div>
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/brown-11.jpg" alt="" src="images/products/brown-11.jpg">
                                            </div>
                                            ...
                                            <a href="#"><i class="icon-arrow1-top-left"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear2.jpg" alt="" src="images/item/tes-wear2.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="text">
                                            Absolutely love this women's athletic wear – the fabric is breathable, the fit is perfect, and the stylish design adds a confident flair to my workout routine.
                                        </div>
                                        <div class="author">
                                            <div class="name">Telna Swith</div>
                                            <div class="metas">Customer from USA</div>
                                        </div>
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/white-17.jpg" alt="" src="images/products/white-17.jpg">
                                            </div>
                                            <div class="content-wrap">
                                                <div class="product-title">
                                                    <a href="#">Ruched Strappy Sports Bra</a>
                                                </div>
                                                <div class="price">$38.00</div>
                                            </div>
                                            <a href="#"><i class="icon-arrow1-top-left"></i></a>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear3.jpg" alt="" src="images/item/tes-wear3.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="text">
                                            This sportswear for women strikes the ideal balance between comfort and performance, making my workouts not only more enjoyable but also more effective.
                                        </div>
                                        <div class="author">
                                            <div class="name">Parane Taylor</div>
                                            <div class="metas">Parane Taylor</div>
                                        </div>
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/blue-5.jpg" alt="" src="images/products/blue-5.jpg">
                                            </div>
                                            <div class="content-wrap">
                                                <div class="product-title">
                                                    <a href="#">Pocket Shorts</a>
                                                </div>
                                                <div class="price">$38.00</div>
                                            </div>
                                            <a href="#"><i class="icon-arrow1-top-left"></i></a>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item style-row">
                                    <div class="image radius-5 o-hidden">
                                        <img class="lazyload" data-src="images/item/tes-wear4.jpg" alt="" src="images/item/tes-wear4.jpg">
                                    </div>
                                    <div class="content">
                                        <div class="rating">
                                            <i class="icon-star"></i>
                                        ...
                                        <div class="text">
                                            The durability of this women's activewear is impressive; it has quickly become my go-to choice for intense workouts without compromising on style.
                                        </div>
                                        <div class="author">
                                        ...
                                        <div class="product">
                                            <div class="img-thumb radius-5 o-hidden">
                                                <img class="lazyload" data-src="images/products/sports-clothing-6.jpg" alt="" src="images/products/sports-clothing-6.jpg">
                                            </div>
                                            <div class="content-wrap">
                                                <div class="product-title">
                                                    <a href="#">Crest 7" Shorts</a>
                                                </div>
                                                <div class="price">$38.00</div>
                                            </div>
                                            <a href="#"><i class="icon-arrow1-top-left"></i></a>
                    ...
                    <div class="nav-sw disable-line nav-next-slider nav-next-testimonial lg"><span class="icon icon-arrow-left"></span></div>
                    <div class="nav-sw disable-line nav-prev-slider nav-prev-testimonial lg"><span class="icon icon-arrow-right"></span></div>
        ...
        <section class="flat-spacing-10">
            <div class="container">
                <div class="flat-title mb_1 wow fadeInUp" data-wow-delay="0s">
                    ...
                    <p class="sub-title text_black-3">Follow <strong>@ecactive</strong> on Instagram</p>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay="0s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/activewear-gallery1.jpg" src="images/shop/gallery/activewear-gallery1.jpg" alt="image-gallery">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".1s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/activewear-gallery2.jpg" src="images/shop/gallery/activewear-gallery2.jpg" alt="image-gallery">
                                    </div>
                                    <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".2s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/activewear-gallery3.jpg" src="images/shop/gallery/activewear-gallery3.jpg" alt="image-gallery">
                                    </div>
                                    <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".3s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/activewear-gallery4.jpg" src="images/shop/gallery/activewear-gallery4.jpg" alt="image-gallery">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/activewear-gallery5.jpg" src="images/shop/gallery/activewear-gallery5.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/activewear-gallery6.jpg" src="images/shop/gallery/activewear-gallery6.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                                </div>
                            </div>
