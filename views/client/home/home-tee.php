<?php include_once "views/client/layout/header.php" ?>
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="images/slider/slideshow1_tee.jpg" src="images/slider/slideshow1_tee.jpg" alt="slideshow" loading="lazy">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="images/slider/slideshow2_tee.jpg" src="images/slider/slideshow2_tee.jpg" alt="slideshow" loading="lazy">
                            <div class="box-content text-center">
                                <div class="container">
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="wrap-slider">
                            <img class="lazyload" data-src="images/slider/slideshow3_tee.jpg" src="images/slider/slideshow3_tee.jpg" alt="slideshow" loading="lazy">
                            <div class="box-content text-center">
                                <div class="container">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="collection-item-centered hover-img">
                                <div class="img-style">
                                    <a href="shop-collection-sub.html">
                                        <img class="lazyload" data-src="images/collections/cls_tee1.jpg" src="images/collections/cls_tee1.jpg" alt="banner-collection">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item-centered hover-img">
                                <div class="img-style">
                                    <a href="shop-collection-sub.html">
                                        <img class="lazyload" data-src="images/collections/cls_tee2.jpg" src="images/collections/cls_tee2.jpg" alt="banner-collection">
                                    </a>
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="collection-item-centered hover-img">
                                <div class="img-style">
                                    <a href="shop-collection-sub.html">
                                        <img class="lazyload" data-src="images/collections/cls_tee3.jpg" src="images/collections/cls_tee3.jpg" alt="banner-collection">
                                    </a>
                                </div>
                                <div class="content">
        ...
        <!-- /Categories -->
        <!-- Banner collection -->
        <section class="banner-collection-men-wrap banner-parallax" style="background-image: url(images/slider/tee-banner-collection.jpg);">
        ...
        <section class="flat-spacing-27">
            <div class="container">
                <div class="flat-title flex-row justify-content-between px-0">
                    <span class="title wow fadeInUp font-caprasimo" data-wow-delay="0s">Featured Products</span>
            ...
            <div class="container-full slider-layout-right">
                <div dir="ltr" class="swiper sw-wrapper-right tf-sw-product-sell"  data-preview="4.5" data-tablet="3.5" data-mobile="2.5" data-space-lg="30" data-space-md="15" data-pagination="3" data-pagination-md="3" data-pagination-lg="4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Amazing Grace Mineral Wash Premium Tee</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">God Behind Bars "God's Purpose" Sand Tee</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">V.3 Mentality Tee</a>
                                    <span class="price">$39.00</span>
                                </div>
                            </div>    
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">"The Pack" Beanie</a>
                                    <span class="price">$39.00</span>
                                </div>
                            </div>  
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Finish The Fight Tie Dye Sweatshirt</a>
                                    <span class="price">$39.00</span>
                                </div>
                            </div>  
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Y'all Tee - Black</a>
                                    <span class="price">$39.00</span>
                                </div>
                            </div>  
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Shein Ezwear Shoulder Tee</a>
                                    <span class="price">$39.00</span>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">"It Is Finished" Bleach Wash Hoodie</a>
                                    <span class="price">$38.00</span>
                                </div>
                            </div>  
                        </div>
        ...
        <!-- /Featured product -->
        <!-- Trending product -->
        <section class="flat-spacing-18 pt_0">
            <div class="container">
                <div class="flat-title flex-row justify-content-between px-0">
                    <span class="title wow fadeInUp font-caprasimo" data-wow-delay="0s">Trending Products</span>
                    <div class="box-sw-navigation">
            ...
            <div class="container-full slider-layout-right">
                <div dir="ltr" class="swiper sw-wrapper-right tf-sw-product-sell-1"  data-preview="4.5" data-tablet="3.5" data-mobile="2.5" data-space-lg="30" data-space-md="15" data-pagination="3" data-pagination-md="3" data-pagination-lg="4">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                <div class="card-product-wrapper rounded-0">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Gratitude Hoodie</a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Y'all Tee - Blush</a>
                                    <span class="price">$38.00</span>
                                </div>
                            </div>  
                        </div>
                        <div class="swiper-slide" lazy="true">
                            <div class="card-product">
                                ...
                                <div class="card-product-info">
                                    <a href="product-detail.html" class="title link font-caprasimo">Victory Crewneck</a>
                                    <span class="price">$38.00</span>
                                </div>
                            </div>  
                        </div>
        ...
        <!-- /Trending product -->
        <!-- Testimonial -->
        <section class="flat-testimonial-bg-v2" style="background-image: url(images/slider/image_bg_testimonials-tee.jpg);">
            <div class="container-full slider-layout-right">
                <div class="row">
                    <div class="col-xl-4">
                    ...
                    <div class="col-xl-8">
                        <div class="wrap-content-right">
                            <div dir="ltr" class="swiper tf-sw-testimonial sw-wrapper-right" data-preview="2.8" data-tablet="2" data-mobile="1" data-space-lg="30" data-space-md="15">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".2s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-1.jpg" src="images/shop/gallery/tee-gallery-1.jpg" alt="image-gallery">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".3s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-2.jpg" src="images/shop/gallery/tee-gallery-2.jpg" alt="image-gallery">
                                    </div>
                                    <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".4s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-3.jpg" src="images/shop/gallery/tee-gallery-3.jpg" alt="image-gallery">
                                    </div>
                                    <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".5s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-4.jpg" src="images/shop/gallery/tee-gallery-4.jpg" alt="image-gallery">
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".6s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-5.jpg" src="images/shop/gallery/tee-gallery-5.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".6s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-6.jpg" src="images/shop/gallery/tee-gallery-6.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".6s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-7.jpg" src="images/shop/gallery/tee-gallery-7.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="gallery-item rounded-0 hover-img wow fadeInUp" data-wow-delay=".6s">
                                    <div class="img-style">
                                        <img class="lazyload img-hover" data-src="images/shop/gallery/tee-gallery-8.jpg" src="images/shop/gallery/tee-gallery-8.jpg" alt="image-gallery">
                                    </div>
                                    <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                                </div>
                            </div>
