...
<!-- Mirrored from themesflat.co/html/ecomus/payment-failure.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Nov 2024 12:14:50 GMT -->
<head>
    <meta charset="utf-8">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-4 col-lg-6 col-md-8">
                        <div class="tf-page-cart-checkout">
                            ...
                            <p class="mb_20">Hey there. We tried to charge your card but, something went wrong. Please update your payment method below to continue</p>
                            <a href="checkout.html" class="tf-btn mb_20 w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
                                <span>Update Payment Method</span>
                            </a>
                            <p>Have a question? <a href="contact-1.html" class="text_primary">Contact Support</a></p>
                        </div>
                    </div>
                </div>
            </div>
