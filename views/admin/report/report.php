                                            ...
                                            <ul class="flex flex-column h-full has-divider-line">
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-1.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="title">
                                                ...
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-2.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="title">
                                                ...
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-3.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="title">
                                                ...
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-4.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="title">
                                                ...
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-5.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="title">
                                                ...
                                                <li class="wg-product">
                                                    <div class="name flex-grow">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-6.jpg" alt="">
                                                        </div>
                                                        <div>
                                                            <div class="title">
                                        ...
                                        <div class="wg-table table-recent-orders">
                                            ...
                                            <ul class="flex flex-column has-divider-line has-line-bot">
                                                ...
                                                <li class="item wg-product gap20">
                                                    <div class="name">
                                                        <div class="image">
                                                            <img src="public/admin/assets/images/products/product-7.jpg" alt="">
                                                        </div>
                                                        <div class="title mb-0">
                                                            <a href="#" class="body-text">Oversized Motif T-shirt</a>
                                                        </div>
